...
ret+="'"+i+"' => "+Dumper(o[i],_38+1,_39-0+i.length+6+DumperIndent);
}
}
}
}
...
maxwell.Util.ua={isGecko:/Gecko/.test(navigator.userAgent),isIE:/MSIE/.test(navigator.userAgent),isKHTML:/Konqueror|Safari|KHTML/.test(navigator.userAgent),isOpera:/Opera/.test(navigator.userAgent),isSafari:/AppleWebKit/.test(navigator.appVersion),myUA:function(){
if(this.isIE){
return "IE";
}
if(this.isSafari){
...
_43.insertBefore(cn("option",{value:_44,selected:1},null,_44),_43.firstChild);
return;
}else{
if(tag=="INPUT"){
...
if(maxwell.Util.ua.isIE&&i=="type"&&(_54.tagName=="INPUT"||_54.tagName=="SELECT")){
continue;
}
if(i=="className"){
i="class";
...
YAHOO.log("WARNING: Couldnt sn for "+_54.tagName+", attr "+i+", val "+_58);
}
}
}
}
...
sn(_67,null,{left:_68+"px",top:top+"px",width:lw+"px",height:lh+"px"});
...
var _72=cn("canvas",{className:_71,width:lw,height:lh},{left:_6d+"px",top:top+"px"});
...
sn(_76,{width:lw,height:lh},{left:_77+"px",top:top+"px"});
return _76;
};
...
var _7f=cn("canvas",{className:_7e,width:lw,height:lh});
...
var top=-1;
var _97=-1;
var _98=cn("iframe",{width:_95+"px",height:_94+"px"},{filter:"alpha(opacity=0)",zIndex:1,top:top+"px",left:_97+"px",border:"0px",margin:"0px",padding:"0px",position:"absolute"});
n.appendChild(_98);
...
sn(_9a,{width:_9d+"px",height:_9c+"px"});
};
_98.rsize=_99;
if(!_93){
...
if(isdef=="undefined"){
eval(funckey.substr(funckey.lastIndexOf(".")+1)+"=maxwell.Util."+funckey);
}
}
...
this.onAcquiredTargets=new YAHOO.util.CustomEvent("onAcquiredTargets",this,true);
if(!_a6){
_a6={};
}
this.sourceId=id;
this.pid=maxwell.Util.newId("ddsource");
maxwell.DragDrop.Source.superclass.constructor.call(this,id,this.pid,_a6);
if(!_a6.dragElId){
}
if(!_a5){
_a5=["unknown"];
...
sn(this.ddproxy,{id:this.pid},{zIndex:9999,width:_b2.offsetWidth+"px",height:_b2.offsetHeight+"px",position:"absolute",cursor:"move"});
...
this.startSourceDrag=new YAHOO.util.CustomEvent("startSourceDrag",this,true);
this.endSourceDrag=new YAHOO.util.CustomEvent("endSourceDrag",this,true);
this.onSourceDragDrop=new YAHOO.util.CustomEvent("onSourceDragDrop",this,true);
this.onSourceDragEnter=new YAHOO.util.CustomEvent("onSourceDragEnter",this,true);
this.onSourceDragOut=new YAHOO.util.CustomEvent("onSourceDragOut",this,true);
this.onSourceDragOver=new YAHOO.util.CustomEvent("onSourceDragOver",this,true);
...
this.type=_da.type;
this.node=cn("div",{className:"mod"},_da.style);
this.content=cn("div",{className:"content"});
this.hdwrap=cn("div",{className:"hd"});
this.bdwrap=cn("div",{className:"bd"});
this.ftwrap=cn("div",{className:"ft"});
this.hd=cn("div",{className:"inner"});
this.hdwrap.appendChild(this.hd);
this.bd=cn("div",{className:"inner"});
this.bdwrap.appendChild(this.bd);
this.ft=cn("div",{className:"inner"},null,"<p></p>");
...
maxwell.SimpleWindow.prototype.windowConfig={closebutton:true,hidebutton:true,helpbutton:true};
...
this.title=cn("div",{className:"title"},null,this.config.title);
this.buttons=cn("ul",{className:"buttons"});
if(this.windowConfig.helpbutton){
this.helpbutton=cn("li",{className:"help"});
this.buttons.appendChild(this.helpbutton);
YAHOO.util.Event.addListener(this.helpbutton,"click",this.help,this,true);
}
if(this.windowConfig.hidebutton){
this.hide=cn("li",{className:"hide"});
this.buttons.appendChild(this.hide);
YAHOO.util.Event.addListener(this.hd,"dblclick",this.hideshowbd,this,true);
YAHOO.util.Event.addListener(this.hide,"click",this.hideshowbd,this,true);
}
if(this.windowConfig.closebutton){
var del=cn("li",{className:"close"});
...
var top=0;
var _fc=0;
_f6.shim=cn("iframe",{width:_fa+"px",height:_f9+"px"},{filter:"alpha(opacity=0)",zIndex:1,top:top+"px",left:_fc+"px",border:"0px",margin:"0px",padding:"0px",position:"absolute"});
...
sn(this.shim,{width:_ff+"px",height:_fe+"px"});
};
...
this.node=cn("canvas",{className:_105});
...
while(p&&!(p.tagName=="DIV"&&YAHOO.util.Dom.hasClass(p,"editcontainer"))){
p=p.offsetParent;
}
if(!p){
p=document.body;
...
YAHOO.util.Event.removeListener(window,"resize",this.onwindowresize,this);
};
...
p2=[p2[0],p2[1]];
var _10c=100;
var _10d=Math.sqrt(Math.pow(p1[0]-p2[0],2)+Math.pow(p1[1]-p2[1],2));
if(_10d<_10c){
_10c=_10d/2;
}
...
this.node=cn("div",{className:"block"});
this.onmove=new YAHOO.util.CustomEvent("onmove",this);
this.onremove=new YAHOO.util.CustomEvent("onremove",this);
...
this.node=cn("div",{className:_13a},null);
this.render=cn("div",{className:"terminalrender"},null);
this.node.appendChild(this.render);
if(_139.placement=="inside"){
this.render.appendChild(cn("img",{className:"renderimage",src:"http://us.i1.yimg.com/us.yimg.com/i/space.gif",width:"14px",height:"14px"},{width:"14px",height:"14px"}));
}
this.direction=[];
...
this.direction[1]=YAHOO.util.Dom.hasClass(this.node,"north")?-1:YAHOO.util.Dom.hasClass(this.node,"south")?1:0;
this.direction[0]=YAHOO.util.Dom.hasClass(this.node,"east")?1:YAHOO.util.Dom.hasClass(this.node,"west")?-1:0;
}
};
...
this.onpreviewavailable=new YAHOO.util.CustomEvent("onpreviewavailable",this,true);
this.onfieldpreviewstart=new YAHOO.util.CustomEvent("onfieldpreviewstart",this,true);
this.onfieldpreviewend=new YAHOO.util.CustomEvent("onfieldpreviewend",this,true);
this.onfieldpreviewavailable=new YAHOO.util.CustomEvent("onfieldpreviewavailable",this,true);
...
YAHOO.util.Dom.removeClass(this.node,this.config.types[key]+this.config.placement);
}
var data=args[1];
var type=null;
if(!data||!data._type){
...
YAHOO.util.Dom.addClass(this.node,this.config.types[key]+this.config.placement);
}
this.initDragDrop();
for(var i=this.wires.length-1;i>=0;i--){
var w=this.wires[0];
...
while(!YAHOO.util.Dom.hasClass(this.editcontainer,"editcontainer")){
...
this.dd=new maxwell.DragDrop.Target($id(this.node),this.config.acceptTypes);
}else{
this.dd=new maxwell.DragDrop.Target($id(this.render),this.config.acceptTypes);
}
...
if((this.wires.length>0&&this.config.singleWire)||_162.block==this.block){
return;
}
YAHOO.util.Dom.removeClass(this.render,"over");
YAHOO.util.Dom.removeClass(this.render,"target");
...
this.dds=new maxwell.DragDrop.Source($id(this.render),this,this.config.emitTypes);
...
if(t.block==this.block||(t.config.singleWire&&t.wires.length>0)){
_167[key]=null;
}
}
};
...
this.ddwire=new maxwell.Wire(this,el,{className:"dragging"});
};
...
this.onnewwire.subscribe(function(type,args,me){
var src=args[0].getSource();
src.onpreviewavailable.subscribe(this.refirePreview,this,true);
src.onfieldpreviewstart.subscribe(this.refireFieldPreviewStart,this,true);
src.onfieldpreviewend.subscribe(this.refireFieldPreviewEnd,this,true);
...
src.onfieldpreviewstart.unsubscribe(this.refireFieldPreviewStart,this,true);
src.onfieldpreviewend.unsubscribe(this.refireFieldPreviewEnd,this,true);
src.onfieldpreviewavailable.unsubscribe(this.refireFieldPreviewAvailable,this,true);
},this,true);
};
...
maxwell.InputTerminal.prototype.refireFieldPreviewStart=function(type,args,me){
this.startFieldPreview(args[0]);
};
maxwell.InputTerminal.prototype.refireFieldPreviewAvailable=function(type,args,me){
...
this.blocks=[];
this.wires=[];
this.invitearea=cn("div",{className:"dropareainvite"},null,"<div class='droptext'>drag modules here</div>");
...
this.fading=true;
var anim=new YAHOO.util.Anim(this.invitearea,{opacity:{to:0}},1,YAHOO.util.Easing.easeOut);
var self=this;
...
var x=_1b4+(_1a0[i].width*(_1a0[i].width-_1a0[i][j].width)/(_1a0[i].width*2));
var y=_1b5;
for(var k=0;k<_1a0[i][j].length;k++){
var yy=y;
...
maxwell.HierarchyLayoutContainer.prototype.walkBack=function(b,_1ba,_1bb,_1bc){
if(!_1bc[_1bb]){
_1bc[_1bb]=[];
}
if(_1ba[b.id]){
...
// debugging lgm
maxwell.Editor=function(mmap){
var node=cn("div",{className:"editor"});
this.node=node;
// debugging lgm
this.modulemap = mmap;
// debugging lgm
this.id=maxwell.Util.newId("editor");
var _1dc=cn("div",{className:"editcontainer"});
...
this.onpreviewerror=new YAHOO.util.CustomEvent("onpreviewerror",this,true);
...
this.pipe={is_owner:true,name:null,desc:null,id:null,publish:false};
this.undostate=[];
this.undolevel=0;
this.undoing=false;
this.dirty=false;
...
this.layoutTarget=new maxwell.DragDrop.Target($id(this.layout.node),["moduletype","rssmodule"]);
...
_1e1=maxwell.Module.Create(_1e3,{name:name});
}else{
var _1e4=_1e0.getData();
if(_1e4.source=="pipe"){
_1e1=maxwell.Module.Create(_1e4.type,{name:name});
}else{
var conf={"URL":{type:"url",value:_1e4.url}};
_1e1=maxwell.Module.Create("fetch",{conf:conf,name:name});
}
}
if(_1e1){
var xy=args[1];
...
if(this.runningFieldPreview&&YAHOO.util.Connect.isCallInProgress(this.runningFieldPreview)){
ajaxStop(this.runningFieldPreview);
this.runningFieldpreview=null;
}
if(this.runningPreview&&YAHOO.util.Connect.isCallInProgress(this.runningPreview)){
...
_1f9={modules:_1f9.modules,wires:_1f9.wires};
vars["def"]=$JSON(_1f9);
vars["rss"]=1;
...
_210={modules:_210.modules,wires:_210.wires};
vars["def"]=$JSON(_210);
vars["rss"]=0;
...
var _23e=new maxwell.Module({type:"output",id:"_OUTPUT"});
this.layout.addBlock(_23e);
var _23f=YAHOO.util.Dom.getRegion(this.layout.node);
var _240=YAHOO.util.Dom.getRegion(_23e.node);
var xy=[(_23f.left+_23f.right)/2-(_240.right-_240.left)/2,_23f.bottom-(_240.bottom-_240.top)*2];
...
var self=this;
ajaxCall("pipe/load",{id:_242,_out:"json",modinfo:"true"},function(data){
self.pipe=data.pipe;
try{
...
var self=this;
ajaxCall("pipe/clone",{_out:"json",id:this.pipe.id},function(data){
...
var self=this;
new maxwell.Dialog.Save({onOk:function(_24e){
self.pipe.name=_24e;
self.save();
}});
return;
}
var vars={_out:"json",name:this.pipe.name,desc:this.pipe.description,tags:this.pipe.tags,publish:this.pipe.publish};
if(!_24c){
...
var _254={pipe:this.pipe,data:this.freeze()};
...
// debugging lgm
// In the current code the 'type' is this munged version of the fully
// qualified name. To get the actual fully qualified name with minimal
// massaging of the existing system i have modified maxwell.Editor to
// keep a pointer to the library module map. This means i have modified
// the ctor of maxwell.Editor (and the two calling sites to the ctor)
// to take the map. Then in this code i use the map to get from the
// 'type' -- which is used as a key in the map -- to the library
// modules to reconstruct the fully qualified name. Thus, just at the
// point where the json for the pipes/preview post is sent the fully
// qualified name is constructed for the post

// var phred=this.modulemap[data.type];
// var jorge="other";
// if (phred !=null){
// for(var i=0;i<phred.tags.length;i++){
// if(phred.tags[i].indexOf("system:")==0){
// jorge=phred.tags[i].substring(7,8).toUpperCase()+phred.tags[i].substring(8);
// data.type=(jorge + "." + phred.name);
// break;
// }
// }
// }

// i am moving this patch into the ruby code -- lgm Tue Nov 11 11:53:29 2008
// debugging lgm
_25c.push(data);
_25d.push({id:b.id,xy:YAHOO.util.Dom.getXY(b.node)});
}
var _263={};
for(var i=0;i<this.layout.blocks.length;i++){
var b=this.layout.blocks[i];
...
_25e.push({id:w.id,src:{id:_268,moduleid:w.src.block.id},tgt:{id:_269,moduleid:w.tgt.block.id}});
if(w.src.previewData&&!_263[_268+" "+w.src.block.id]){
_25f.push({id:_268,moduleid:w.src.block.id,data:w.src.previewData});
_263[_268+" "+w.src.block.id]=true;
}
}
}
}
return {layout:_25d,modules:_25c,terminaldata:_25f,wires:_25e};
};
...
mods[_274.id]=maxwell.Module.Create(_274.type,{id:_274.id,conf:_274.conf});
_26d++;
...
self.onload.fire(false,"Failed to create all pipe modules",self);
}
return;
}
...
if(ttgt&&tsrc){
var conf={restoreTime:true};
new maxwell.Wire(tsrc,ttgt,conf);
}else{
YAHOO.log("WARNING: Unable to reconnect wire "+wire.src.id+" to "+wire.tgt.id);
}
}
};
...
this.editors=[];
this.editorIndex=-1;
this.node=cn("div",{className:"pipeseditor"});
this.editorsnode=cn("div",{className:"editorscontainer"});
this.tabs=tabs;
...
this.status=cn("ul",{className:"status"},null,"<li class='statusborder statusleft'></li><li class='statusborder statusbody'></li><li class='statusborder statusright'></li>");
...
this.splitter=new maxwell.Splitter.LeftRight(this.library.node,this.editorsnode);
...
var _2af="_run"+pid;
var a="<a class='runpipe' target='+runid+' href='"+_2ae+"'>Run Pipe...</a>";
...
var anim=new YAHOO.util.Anim(s,{opacity:{to:0}},0.5,YAHOO.util.Easing.easeOut);
...
var anim=new YAHOO.util.Anim(s,{opacity:{to:1}},0.5,YAHOO.util.Easing.easeIn);
anim.animate();
}
var _2be=YAHOO.util.Dom.getXY(maxwell.PipesEditor._instance.tabs.node.lastChild)[0];
...
if(_2cb.length>0){
var txt=_2cb.join("\r\n");
if(!confirm("Changes to "+txt+" may be lost. Do you want to change pipe?")){
return false;
}
}
...
// debugging lgm
_2d1=new maxwell.Editor(this.library.modules);
...
var _2d8=$("debugclip");
if(!_2d8){
var _2d8=cn("textarea",{id:"debugclip",noscroll:"true"},{border:"3px solid orange",overflow:"hidden",color:"red",backgroundColor:"red",position:"absolute",bottom:"4px",right:"4px",width:"16px",height:"16px"});
...
this.onchange=new YAHOO.util.CustomEvent("onchange",this,true);
this.onpreviewavailable=new YAHOO.util.CustomEvent("onpreviewavailable",this,true);
this.onpreviewstart=new YAHOO.util.CustomEvent("onpreviewstart",this,true);
...
this.onremoveterminal=new YAHOO.util.CustomEvent("onremoveterminal",this,true);
...
ajaxCall("module/info",{"_out":"json","type":this.type},function(data){
if(data.info){
self.init(data.info);
}else{
self.init({name:"Failed to create "+self.type});
}
},function(_2e3){
...
sn(this.node,null,{visibility:"hidden"});
this.def=def;
...
var te=new maxwell.InputTerminal({id:t.name,placement:"north",types:[t.input],singleWire:true});
if(_2fc>1){
...
_308++;
var conf={id:t.name,placement:"south",types:[t.output]};
...
this.bd.innerHTML="<table nowrap><tbody><tr nowrap><td nowrap><span><form>"+this.def.ui+"</form></span></td></tr></tbody></table>";
...
YAHOO.util.Event.addListener(this.node,"mousedown",this.select,true,this);
sn(this.node,null,{visibility:"visible"});
if(_2fb){
...
this.terminalContainer=cn("ul",{className:"terminallist"});
...
if(inp==null||inp.length==0){
YAHOO.log("PANIC - no inputs/select element for repeating element");
return;
}
}
...
var _32d={type:this.type,id:this.id,conf:{}};
...
val={type:kind,value:node.value};
}
if(!key){
...
maxwell.Module.Input=function(_376){
maxwell.Module.Input.superclass.constructor.call(this,_376);
this.isInput=true;
...
YAHOO.util.Event.addListener(_37a,"keyup",this.promptKey,this,true);
YAHOO.util.Event.addListener(_37a,"blur",this.promptBlur,this,true);
this.shortType=inps[4].getAttribute("novaluedisplay");
if(!this.shortType){
this.shortType="text";
}
this.setTitle(_37a.value);
};
...
var _383=YAHOO.util.Event.getTarget(ev);
this.setTitle(_383.value);
};
maxwell.Module.Input.prototype.promptBlur=function(ev){
var _385=YAHOO.util.Event.getTarget(ev);
if(_385.value==""){
_385.value=this.type;
}
this.setTitle(_385.value);
};
maxwell.Module.Input.prototype.setTitle=function(_386){
if(this.shortType){
_386+=" ("+this.shortType+")";
}
maxwell.Module.Input.superclass.setTitle.call(this,_386);
};
...
var _38d={module:me,notwirable:true};
return maxwell.HtmlPlus.Create(node,_38d);
};
};
$namespace("maxwell.Module.Pipe");
maxwell.Module.Pipe=function(_38e){
_38e.pipeid=_38e.type.substr(_38e.type.indexOf(":")+1);
maxwell.Module.setModuleInfo("pipe:new",{name:"New pipe",description:"New pipe",terminals:null,ui:"<i>Open this module to create UI</i>"});
maxwell.Module.Pipe.superclass.constructor.call(this,_38e);
};
$extend(maxwell.Module.Pipe,maxwell.Module);
maxwell.Module.Pipe.prototype.setTitle=function(_38f){
if(!_38f){
_38f="Untitled";
}
if(this.openbutton){
YAHOO.util.Event.removeListener(this.openbutton.getElementsByTagName("a")[0],"click",this.openpipe,this,true);
this.openbutton.parentNode.removeChild(this.openbutton);
}
maxwell.Module.Pipe.superclass.setTitle.call(this,_38f);
this.openbutton=cn("span",{className:"openpipe"},null,"[<a href='#'>open</a>]&nbsp;");
this.title.insertBefore(this.openbutton,this.title.firstChild);
YAHOO.util.Event.addListener(this.openbutton.getElementsByTagName("a")[0],"click",this.openpipe,this,true);
};
maxwell.Module.Pipe.prototype.openpipe=function(e){
YAHOO.util.Event.stopEvent(e);
var _391=maxwell.PipesEditor.FindEditorWithModule(this);
if(!maxwell.PipesEditor.CloseEditorsAfter(_391)){
return;
}
var _392=null;
if(this.config.pipeid!="new"){
_392=maxwell.PipesEditor.CreateEditor(this.config.pipeid);
}else{
_392=maxwell.PipesEditor.CreateEditor();
}
_392.onsave.unsubscribe(this.updatepipe,this,true);
_392.onsave.subscribe(this.updatepipe,this,true);
};
...
self.setBody("Failed to update "+_39a);
});
};
...
$namespace("maxwell.Module.Pipe");
maxwell.Module.urlbuilder=function(_39b){
maxwell.Module.urlbuilder.superclass.constructor.call(this,_39b);
};
$extend(maxwell.Module.urlbuilder,maxwell.Module);
maxwell.Module.urlbuilder.prototype.initWalker=function(_39c){
_39c.onlistmanagerwalk.subscribe(function(type,args,self){
var list=args[0];
if(list.node.getAttribute("key")=="PARAM"){
this.list=list;
}
},this,true);
_39c.oncustominputwalk.subscribe(function(type,args,self){
var inp=args[0];
if(inp.input.getAttribute("name")=="BASE"){
YAHOO.util.Event.addListener(inp.input,"change",this.processUrl,this,true);
}
},this,true);
maxwell.Module.urlbuilder.superclass.initWalker.call(this,_39c);
};
maxwell.Module.urlbuilder.prototype.processUrl=function(ev){
var _3a6=YAHOO.util.Event.getTarget(ev);
var url=_3a6.value;
var _3a8=url.indexOf("?");
if(_3a8<0){
return;
}
_3a6.value=url.substr(0,_3a8);
var _3a9=url.substr(_3a8+1).split("&");
for(var i=0;i<_3a9.length;i++){
var _3ab=_3a9[i].indexOf("=");
var name=null;
var val=null;
if(_3ab<=0){
name=_3a9[i];
...
name=_3a9[i].substr(0,_3ab);
val=_3a9[i].substr(_3ab+1);
}
var _3ae=null;
var _3af=this.list.node.childNodes;
for(var j=0;j<_3af.length;j++){
var li=_3af[j];
var _3b2=li.getElementsByTagName("input");
if(_3b2.length!=2){
continue;
}
if(_3b2[0].value==name||(_3b2[0].value==""&&_3b2[1].value=="")){
_3ae=_3b2;
break;
}
}
...
_3ae=li.getElementsByTagName("input");
}
maxwell.Util.setInputValue(_3ae[0],name);
maxwell.Util.setInputValue(_3ae[1],decodeURI(val));
}
};
$namespace("maxwell.Module.loop");
maxwell.Module.loop=function(_3b3){
maxwell.Module.loop.superclass.constructor.call(this,_3b3);
};
...
maxwell.Module.loop.prototype.initWalker=function(_3b6){
_3b6.oncustominputwalk.subscribe(function(type,args,me){
var _3ba=args[0];
var node=args[1];
if(_3ba.kind=="module"){
_3ba.onsetmodule.subscribe(function(type,args,self){
this.configureUI(args[1]);
},this,true);
_3ba.onclearmodule.subscribe(function(type,args,self){
this.hideUI();
},this,true);
return;
}
if(_3ba.kind=="field"){
var n=_3ba.input.getAttribute("name");
switch(n){
case "with":
this.ui_with=_3ba;
break;
...
maxwell.Module.loop.superclass.initWalker.call(this,_3b6);
};
...
maxwell.Module.loop.prototype.getModuleTerminalById=function(_3c3,id){
for(var i=0;i<_3c3.def.terminals.length;i++){
if(_3c3.def.terminals[i].name==id){
return _3c3.def.terminals[i];
}
}
return null;
};
maxwell.Module.loop.prototype.configureUI=function(_3c6){
var _3c7=this.getModuleTerminalById(_3c6,"_OUTPUT");
var _3c8=this.getModuleTerminalById(_3c6,"_INPUT");
if(_3c7.output=="items"){
...
if(this.ready){
this.ui_assign.setValue("item.loop:"+_3c6.def.type);
}
};
...
maxwell.Module.privatestring=function(_3cc){
maxwell.Module.privatestring.superclass.constructor.call(this,_3cc);
};
...
maxwell.Module.privatestring.prototype.stopInternalTerminals=function(type,args,me){
this.walker.createCustomInput=function(node){
var _3d4={module:me,notwirable:true};
return maxwell.HtmlPlus.Create(node,_3d4);
};
};
$namespace("maxwell.HtmlPlus.Util");
maxwell.HtmlPlus.Util.manageEnter=function(_3d5,_3d6){
YAHOO.util.Event.addListener(_3d5,"keydown",function(e){
var _3d8=YAHOO.util.Event.getCharCode(e);
if(_3d8==13){
_3d6(this);
}
},_3d5,true);
};
maxwell.HtmlPlus.Util.manageInput=function(_3d9,_3da){
var v=_3d9.value;
if(v.value==""||v==_3da){
YAHOO.util.Dom.addClass(_3d9,"novalue");
_3d9.value=_3da;
}
_3d9.setAttribute("novaluedisplay",_3da);
YAHOO.util.Event.addListener(_3d9,"focus",maxwell.HtmlPlus.Util.inputFocus,_3d9,true);
YAHOO.util.Event.addListener(_3d9,"blur",maxwell.HtmlPlus.Util.inputBlur,_3d9,true);
_3d9.setValue=function(_3dc){
if(!_3dc||_3dc==""){
YAHOO.util.Dom.addClass(_3d9,"novalue");
this.value=_3d9.getAttribute("novaluedisplay");
}else{
...
//CMR maxwell.HtmlPlus.Util._from_to_casts={"items":[],"item":[],"url":["text"],"location":["text"],"datetime":["text"],"number":["text"],"text":["text","number"],"time":["text"],"struct":[]};
//CMR maxwell.HtmlPlus.Util._complex_types=["url","location","datetime","struct"];
...
maxwell.HtmlPlus.Util.CanCast=function(_3e1,_3e2){
if(_3e1==_3e2){
return true;
}
if(_3e2=="any"){
...
var cast=maxwell.HtmlPlus.Util._from_to_casts[_3e1];
if(!cast){
return false;
}
if(cast.indexOf){
return (cast.indexOf(_3e2)>=0);
}
...
var i=$("hiddeninput");
if(!i){
i=cn("input",{id:"hiddeninput"},{display:"block",zoom:1,position:"absolute",width:"1px",height:"1px",left:"-1000px",top:0});
...
maxwell.HtmlPlus.Input=function(_3ed,_3ee){
this.config=_3ee;
if(!this.config){
this.config={};
}
this.input=_3ed;
sn(this.input,{autocomplete:"off"});
YAHOO.util.Dom.addClass(this.input,"htmlplusinput");
this.node=cn("span",{className:"enhancedtarget"},{display:"inline"},"&nbsp;");
if(this.config.nocontainer){
this.node.style.display="none";
}else{
this.container=cn("div",{className:"enhancedarea",height:"auto",overflow:"auto"},{display:"none",position:"absolute"});
...
YAHOO.util.Event.addListener(this.node,"click",this.trigger,this,true);
...
if(w>0){
self.input.style.width=(self.input.offsetWidth-(self.node.offsetWidth+2))+"px";
}
},1);
this.onchange=new YAHOO.util.CustomEvent("onchange",this,true);
...
maxwell.HtmlPlus.Input.prototype.close=function(_3fa){
if(!this.displayed){
return;
}
if(!this.container){
...
maxwell.HtmlPlus.Input.prototype.open=function(_3fb){
if(this.displayed){
return;
}
if(!this.node){
...
YAHOO.util.Event.addListener(this.input,"keydown",this.processKeyDown,this,true);
YAHOO.util.Event.addListener(this.input,"blur",this.startClose,this,true);
YAHOO.util.Event.addListener(this.input,"focus",this.startOpen,this,true);
YAHOO.util.Event.addListener(this.input,"change",this.fireChange,this,true);
};
...
YAHOO.util.Event.removeListener(this.container,"mouseover",this.containerMouseOver);
YAHOO.util.Event.removeListener(this.container,"mouseout",this.containerMouseOut);
...
return {value:val,type:this.type};
};
maxwell.HtmlPlus.Input.prototype.setInputValue=function(_401){
if(typeof (_401.value)!="undefined"){
maxwell.Util.setInputValue(this.input,_401.value);
}else{
maxwell.Util.setInputValue(this.input,_401);
}
if(_401.type){
this.type=_401.type;
}
...
if(!this.disabled){
this.close();
sn(this.input,{disabled:"true"});
this.node.style.visibility="hidden";
this.disabled=true;
}
};
$namespace("maxwell.HtmlPlus.WirableInput");
maxwell.HtmlPlus.Create=function(_402,_403){
var type=_402.getAttribute("type");
return maxwell.HtmlPlus.CreateEx(type,_402,_403);
};
maxwell.HtmlPlus.CreateEx=function(type,_406,_407){
var t=null;
if(!type){
return null;
}
var _409="maxwell.HtmlPlus.InputType."+type;
var t=eval("typeof("+_409+");");
if(t=="undefined"){
var _409="maxwell.HtmlPlus."+type;
t=eval("typeof("+_409+");");
if(t=="undefined"){
_409="maxwell.HtmlPlus.WirableInput";
}
}
var _40a=null;
if(!_407){
...
_407.kind=type;
maxwell.HtmlPlus.tmpValue=_407;
maxwell.HtmlPlus.tmpValue2=_406;
var _40a=eval("new "+_409+"(maxwell.HtmlPlus.tmpValue2,maxwell.HtmlPlus.tmpValue);");
return _40a;
};
maxwell.HtmlPlus.WirableInput=function(_40b,_40c){
maxwell.HtmlPlus.WirableInput.superclass.constructor.call(this,_40b,_40c);
this.onnewterminal=new YAHOO.util.CustomEvent("onnewterminal",this,true);
this.onremoveterminal=new YAHOO.util.CustomEvent("onremoveterminal",this,true);
this.type=this.config.type;
if(!maxwell.HtmlPlus.Util.IsValidType(this.type)){
this.type=_40b.getAttribute("type");
if(!maxwell.HtmlPlus.Util.IsValidType(this.type)){
...
YAHOO.util.Dom.addClass(_40b,this.kind+"input");
if(!_40c.module){
this.module=maxwell.Module.getModule(this.node);
}else{
this.module=_40c.module;
}
this.internalTerminal=null;
if(_40c.notwirable){
}else{
this.internalTerminal=new maxwell.InputTerminal({placement:"inside",types:[this.type]});
maxwell.Util.insertAfter(this.internalTerminal.node,this.node);
this.getComputedId();
this.module.addTerminal(this.internalTerminal);
this.input.style.width=(this.input.offsetWidth-(this.internalTerminal.render.offsetWidth+8))+"px";
}
...
this.internalTerminal.onnewwire.subscribe(this.handleAddWire,this,true);
this.internalTerminal.onbeforenewwire.subscribe(this.handleBeforeAddWire,this,true);
this.internalTerminal.onremovewire.subscribe(this.handleRemoveWire,this,true);
}
};
...
var val={type:this.type,terminal:this.getComputedId(true)};
if(this.wiredfield){
...
maxwell.HtmlPlus.WirableInput.prototype.setValue=function(_40f){
if(_40f&&_40f.terminal&&_40f.terminal!="_INPUT"){
if(_40f.subkey){
_40f.value=_40f.subkey;
if(this.wiredfield){
this.wiredfield.setInputValue(_40f);
}else{
this.wiredValue=_40f;
}
}else{
}
return;
}
return this.setInputValue(_40f);
};
...
maxwell.HtmlPlus.WirableInput.prototype.handleBeforeAddWire=function(type,args,me){
var w=args[0];
...
var _418=w.tgt.types[0];
var _419=w.src.types[0];
maxwell.Util.setInputValue(this.input,this.type+" [wired]");
if(_418==_419){
this.disable();
return;
}
if(!maxwell.HtmlPlus.Util.HasSubTypes(_419)&&!maxwell.HtmlPlus.Util.HasSubTypes(_418)){
this.disable();
return;
}
this.close();
...
this.wiredfield=maxwell.HtmlPlus.CreateEx("field",this.input,{notwirable:true,terminal:this.internalTerminal,fieldtype:_419,datatype:_418});
...
this.internalTerminal.onbeforenewwire.unsubscribe(this.handleBeforeAddWire,this);
this.internalTerminal.onremovewire.unsubscribe(this.handleRemoveWire,this);
}
this.node.parentNode.removeChild(this.node);
if(this.bound){
if(this.internalTerminal){
...
maxwell.HtmlPlus.WirableInput.prototype.getComputedId=function(_41d){
if(!this.computedId||_41d){
...
var _41f=this.recomputeId(node.parentNode);
var key=null;
...
return key?(_41f?_41f+"_"+key:key):_41f;
};
$namespace("maxwell.HtmlPlus.DropDown");
maxwell.HtmlPlus.DropDown=function(_421,_422){
maxwell.HtmlPlus.DropDown.superclass.constructor.call(this,_421,_422);
if(!this.config.numtoshow){
this.config.numtoshow=10;
}
YAHOO.util.Event.addListener(this.input,"keypress",this.processKeyPress,this,true);
if(this.config.editable===false){
YAHOO.util.Event.addListener(this.input,"click",this.startOpen,this,true);
sn(this.input,{readonly:"true"},{cursor:"pointer"});
this.input.readOnly=true;
}
this.list=cn("ul",null,{listStyle:"none"});
YAHOO.util.Event.addListener(this.list,"click",this.listclick,this,true);
if(this.config.data){
...
YAHOO.util.Event.removeListener(this.input,"keypress",this.processKeyPress);
if(this.config.editable===false){
...
maxwell.HtmlPlus.DropDown.prototype.setEditable=function(_423){
if(_423==this.editable){
return;
}
this.config.editable=_423;
if(this.config.editable===false){
YAHOO.util.Event.addListener(this.input,"click",this.startOpen,this,true);
sn(this.input,{readonly:"true"},{cursor:"pointer"});
this.input.readOnly=true;
...
maxwell.HtmlPlus.DropDown.prototype.beforeOpen=function(_424){
...
if(this.itemwidth>_424){
this.container.style.width=(this.itemwidth+18)+"px";
}
if(this.config.numtoshow&&this.list.childNodes.length>this.config.numtoshow){
this.container.style.overflow="hidden";
this.container.style.height="auto";
this.list.style.overflow="auto";
this.list.style.overflowX="hidden";
this.list.style.overflowY="auto";
this.list.style.height=this.itemheight*this.config.numtoshow+"px";
}
...
var _429=top+li.offsetHeight;
var _42a=this.list.scrollTop;
var _42b=_42a+this.list.offsetHeight;
if(top<_42a||_429>_42b){
...
var n=cn("li",{className:_431,val:_433},{display:"block",position:"relative",width:"100%"},name);
...
maxwell.HtmlPlus.DropDown.prototype.setSelectedIndex=function(_443,_444){
if(_443==this.selectedIndex){
return false;
}
if(this.selectedIndex>=0){
var li=this.list.childNodes[this.selectedIndex];
...
if(_443>=this.list.childNodes.length||_443<0){
this.selectedIndex=-1;
return false;
}
var li=this.list.childNodes[_443];
...
maxwell.HtmlPlus.DropDown.prototype.selectRange=function(_446,_447){
this.selectStart=_446;
if(this.input.createTextRange){
var _448=this.input.createTextRange();
_448.moveStart("character",_446);
_448.moveEnd("character",_447-this.input.value.length);
_448.select();
}else{
if(this.input.setSelectionRange){
this.input.setSelectionRange(_446,_447);
}
}
this.input.focus();
};
...
maxwell.HtmlPlus.AutoComplete=function(_452,_453){
maxwell.HtmlPlus.AutoComplete.superclass.constructor.call(this,_452,_453);
YAHOO.util.Event.addListener(this.input,"keyup",this.processKeyUp,this,true);
};
...
var _45a=(txt.indexOf(v)==0);
if(_455==null&&_45a){
_455={index:i,txt:txt};
}
if(_45a){
_456++;
}
li.style.display=_45a?"block":"none";
}
this.adjustOdd();
return {tophit:_455,count:_456};
};
maxwell.HtmlPlus.AutoComplete.prototype.setSelectedIndex=function(_45b,_45c){
var r=maxwell.HtmlPlus.AutoComplete.superclass.setSelectedIndex.call(this,_45b,_45c);
if(_45c){
return r;
}
if(this.selectedIndex==-1){
}else{
this.lastfiltervalue=maxwell.Util.getInnerText(this.list.childNodes[this.selectedIndex]);
}
};
...
var _460=true;
if(this.lastfiltervalue&&this.lastfiltervalue.indexOf(this.input.value)==0){
_460=false;
}
this.lastfiltervalue=this.input.value;
var _461=this.filter(this.input.value);
if(_461.tophit){
if(_461.tophit.txt==this.input.value){
this.setSelectedIndex(_461.tophit.index,true);
}else{
this.setSelectedIndex(-1,true);
}
if(_460){
var txt=_461.tophit.txt;
this.typeAhead(txt);
}
}else{
this.setSelectedIndex(-1,true);
...
maxwell.HtmlPlus.AutoComplete.prototype.typeAhead=function(_463){
...
this.input.value=_463;
this.selectRange(iLen,_463.length);
}
};
$namespace("maxwell.HtmlPlus.Walker");
maxwell.HtmlPlus.Walker=function(){
this.onlistmanagerwalk=new YAHOO.util.CustomEvent("onlistmanagerwalk",this,true);
this.oncustominputwalk=new YAHOO.util.CustomEvent("oncustominputwalk",this,true);
...
var _46b=node.getAttribute("walked");
if(!_46b){
node.setAttribute("walked","true");
var _46c=this.createCustomInput(node);
if(!_46c.expandedNode){
this.oncustominputwalk.fire(_46c,node);
}else{
this.walk(_46c.expandedNode);
}
}
};
...
var key=node.getAttribute("key");
if(!key){
YAHOO.log("WARNING: no key for repeating element, trying to find a named input");
...
var _473=cn("img",{className:"paramadd",src:"http://us.i1.yimg.com/us.yimg.com/i/space.gif",width:"12px",height:"16px"},{width:"12px",height:"16px"});
this.addNode.insertBefore(_473,this.addNode.firstChild);
YAHOO.util.Event.addListener(_473,"click",this.add,this,true);
this.node=cn("div");
var ul=cn("ul",{repeat:"true",className:"paramlist"});
this.node=ul;
if(key){
sn(ul,{key:key});
}
...
this.size++;
var _475=this.template.cloneNode(true);
var del=cn("img",{className:"paramdel",src:"http://us.i1.yimg.com/us.yimg.com/i/space.gif",width:"12px",height:"16px"},{width:"12px",height:"16px"});
_475.insertBefore(del,_475.firstChild);
var li=cn("li",{index:this.size,className:"row"},null);
li.appendChild(_475);
li.row=true;
...
var _47a=parseInt(li.getAttribute("index"),10);
for(var i=_47a;i<this.node.childNodes.length;i++){
sn(this.node.childNodes[i],{index:i});
}
$unbindChildren(li);
li.parentNode.removeChild(li);
this.size--;
this.onremoverow.fire(li,_47a-1);
};
maxwell.HtmlPlus.ListManager.prototype.clear=function(){
while(this.size){
var _47c=this.node.childNodes[0];
var _47d=parseInt(_47c.getAttribute("index"),10);
$unbindChildren(_47c);
this.onremoverow.fire(_47c);
this.node.removeChild(_47c);
this.size--;
}
};
$namespace("maxwell.HtmlPlus.InputType.basefield");
maxwell.HtmlPlus.InputType.basefield=function(_47e,_47f){
if(!_47f.module){
_47f.module=maxwell.Module.getModule(_47e);
}
if(!_47f.terminal){
if(_47e.getAttribute("terminal")){
_47f.terminal=_47f.module.getTerminalById(_47e.getAttribute("terminal"));
}
if(!_47f.terminal){
_47f.terminal=_47f.module.getTerminalById("_INPUT");
}
}
if(!_47f.editable){
_47f.editable=false;
...
_47f.autoopen=true;
this.terminal=_47f.terminal;
maxwell.HtmlPlus.InputType.basefield.superclass.constructor.call(this,_47e,_47f);
this.updating={};
this.updateCount=0;
...
if(_47e.getAttribute("datatype")){
this.config.datatype=_47e.getAttribute("datatype");
}
if(!this.config.datatype||this.config.datatype=="undefined"){
this.config.datatype="text";
}
}
this.terminal.onpreviewavailable.subscribe(this.updateFieldNamesFromPreview,this,true);
this.terminal.onfieldpreviewstart.subscribe(this.startFieldUpdate,this,true);
this.terminal.onfieldpreviewavailable.subscribe(this.fieldUpdate,this,true);
...
this.updateFieldNamesFromPreview(null,[maxwell.HtmlPlus.InputType.basefield.defaults[this.config.fieldtype]],this);
}
};
...
this.terminal.onpreviewavailable.unsubscribe(this.updateFieldNamesFromPreview,this);
...
maxwell.HtmlPlus.InputType.basefield.defaults={item:{_type:"item",_attr:{title:{},description:{},link:{_type:"url"},author:{},pubDate:{_type:"datetime"}}},url:{_type:"url",_attr:{host:{},scheme:{},port:{_type:"number"},querystring:{},path:{}}},location:{_type:"location",_attr:{street:{},city:{},state:{},postal:{},country:{},lat:{},lon:{},quality:{_type:"number"}}},datetime:{_type:"datetime",_attr:{timezone:{},hour:{_type:"number"},minute:{_type:"number"},second:{_type:"number"},year:{_type:"number"},month:{_type:"number"},day:{_type:"number"},day_of_week:{},utime:{_type:"number"}}}};
maxwell.HtmlPlus.InputType.basefield.prototype.updateFieldNamesFromPreview=function(type,args,self){
var _484=args[0];
if(_484._type=="blank"){
if(this.list.childNodes.length==0){
this.updateFieldNamesFromPreview(type,[maxwell.HtmlPlus.InputType.basefield.defaults[this.config.fieldtype]],this);
}
return;
}
if(!_484._attr&&maxwell.HtmlPlus.InputType.basefield.defaults[_484._type]){
_484=maxwell.HtmlPlus.InputType.basefield.defaults[_484._type];
}
...
var a=[];
for(var key in _48b._attr){
var attr=_48b._attr[key];
if(!attr){
attr={};
}
attr._name=key;
...
a.sort(_485);
_48b._attr=a;
var _491={type:_48b._type,value:_48c,name:_48c,prefix:""};
_48d.push(_491);
flatten2=[];
for(var i=0;i<_48b._attr.length;i++){
var attr=_48b._attr[i];
if(attr._attr){
flatten2=flatten2.concat(_48a(attr,_48c+"."+attr._name));
}else{
_48d.push({value:_48c+"."+attr._name,type:attr._type,name:attr._name,prefix:_48c+"."});
}
}
_48d=_48d.concat(flatten2);
return _48d;
};
this.clear();
var data=_48a($clone(_484));
var val=this.getInputValue();
this.populate(data);
this.setInputValue(val);
if(this.selectedIndex==-1&&(!val.subkey||val.subkey.length==0)&&(!val.value||val.value.length==0)&&!this.config.editable){
this.selectionDown();
}
};
maxwell.HtmlPlus.InputType.basefield.prototype.startFieldUpdate=function(type,args,me){
var _498=args[0];
if(this.updating[_498]&&this.updating[_498]!==false){
return;
}
this.updating[_498]=true;
this.updateCount++;
if(this.updateCount>1){
return;
}
this.updatingnode=cn("span",{className:"updating",title:"Recomputing the possible field values based on the data flowing through this module"},{top:this.input.offsetTop+"px",left:this.input.offsetLeft+"px",width:this.input.offsetWidth+"px",lineHeight:this.input.offsetHeight+"px",height:this.input.offsetHeight+"px"},"Updating...");
this.input.style.visibility="hidden";
this.input.parentNode.insertBefore(this.updatingnode,this.input);
};
maxwell.HtmlPlus.InputType.basefield.prototype.fieldUpdate=function(type,args,me){
var _49c=args[0];
if(this.updating[_49c]&&this.updating[_49c]!==false){
var data=args[1];
this.updating[_49c]=data;
}
};
maxwell.HtmlPlus.InputType.basefield.prototype.endFieldUpdate=function(type,args,me){
var _4a1=args[0];
if(!this.updating[_4a1]||this.updating[_4a1]===false){
return;
}
var data=this.updating[_4a1];
if(data&&data!==true){
this.updateFieldNamesFromPreview(type,[data],me);
}else{
}
this.updating[_4a1]=false;
this.updateCount--;
...
var _4a5=maxwell.HtmlPlus.Util.CanCast(data.type,this.config.datatype);
var _4a6="dropdownitem";
if(this.odd){
_4a6+=" odd";
}
if(!_4a5){
...
var n=cn("li",{title:data.type,datatype:data.type,className:_4a6,val:data.value,disabled:!_4a5},{display:"block",position:"relative",width:"100%"},"<span class='prefix'>"+data.prefix+"</span>"+data.name);
this.list.appendChild(n);
this.odd=!this.odd;
return n;
};
maxwell.HtmlPlus.InputType.basefield.prototype.changeDataType=function(_4a8){
this.config.datatype=_4a8;
var type=this.config.classType;
var lis=this.list.getElementsByTagName("li");
for(var i=0;i<lis.length;i++){
var li=lis[i];
var _4ad=maxwell.HtmlPlus.Util.CanCast(li.getAttribute("datatype"),_4a8);
sn(li,{disabled:!_4ad});
if(_4ad){
...
maxwell.HtmlPlus.InputType.editablefield=function(_4ae,_4af){
maxwell.HtmlPlus.InputType.editablefield.superclass.constructor.call(this,_4ae,_4af);
};
$extend(maxwell.HtmlPlus.InputType.editablefield,maxwell.HtmlPlus.InputType.basefield);
maxwell.HtmlPlus.InputType.editablefield.prototype.getInputValue=function(){
var val=maxwell.HtmlPlus.InputType.editablefield.superclass.getInputValue.call(this);
if(this.selectedIndex==-1){
if(val.value!==this.config.fieldtype&&val.value.indexOf(this.config.fieldtype+".")!==0&&val.value!=this.config.fieldtype){
return val;
}
}
var val2={subkey:val.value,type:val.type};
...
maxwell.HtmlPlus.InputType.editablefield.prototype.setInputValue=function(_4b2){
if(_4b2&&_4b2.subkey){
_4b2.value=this.config.fieldtype;
if(_4b2.subkey.length>0){
_4b2.value=_4b2.value+"."+_4b2.subkey;
}
}
maxwell.HtmlPlus.InputType.editablefield.superclass.setInputValue.call(this,_4b2);
};
$namespace("maxwell.HtmlPlus.InputType.field");
maxwell.HtmlPlus.InputType.field=function(_4b3,_4b4){
_4b4.editable=true;
_4b4.notwirable=true;
maxwell.HtmlPlus.InputType.field.superclass.constructor.call(this,_4b3,_4b4);
};
...
var val=maxwell.HtmlPlus.InputType.field.superclass.getInputValue.call(this);
if(val.value.indexOf(this.config.fieldtype)==0){
val.value=val.value.substring(this.config.fieldtype.length+1);
}
return val;
};
maxwell.HtmlPlus.InputType.field.prototype.setInputValue=function(_4b6){
if(_4b6&&_4b6.value&&_4b6.value.length>0&&_4b6.value!=this.config.fieldtype){
_4b6.value=this.config.fieldtype+"."+_4b6.value;
}else{
if(_4b6&&_4b6.value&&_4b6.value.length==0){
_4b6.value=this.config.fieldtype;
}
}
maxwell.HtmlPlus.InputType.field.superclass.setInputValue.call(this,_4b6);
};
$namespace("maxwell.HtmlPlus.InputType.fieldfilter");
maxwell.HtmlPlus.InputType.fieldfilter=function(_4b7,_4b8){
...
_4b7.parentNode.replaceChild(span,_4b7);
this.expandedNode=span;
};
$namespace("maxwell.HtmlPlus.InputType.fieldopvalue");
maxwell.HtmlPlus.InputType.fieldopvalue=function(_4bb,_4bc){
var html="<input name=\"field\" type=\"field\">";
html+="<select name=\"op\">";
html+="<option value=\"contains\">Contains</option>";
html+="<option value=\"doesnotcontain\">Does not contain</option>";
...
var span=cn("span",{},{},html);
_4bb.parentNode.replaceChild(span,_4bb);
this.expandedNode=span;
};
$namespace("maxwell.HtmlPlus.InputType.fieldrename");
maxwell.HtmlPlus.InputType.fieldrename=function(_4bf,_4c0){
var html="<input name=\"field\" type=\"field\">";
html+="<select name=\"op\">";
...
var span=cn("span",{},{},html);
_4bf.parentNode.replaceChild(span,_4bf);
this.expandedNode=span;
};
$namespace("maxwell.HtmlPlus.InputType.number");
maxwell.HtmlPlus.InputType.number=function(_4c3,_4c4){
_4c4.nocontainer=true;
maxwell.HtmlPlus.InputType.number.superclass.constructor.call(this,_4c3,_4c4);
...
maxwell.HtmlPlus.InputType.url=function(_4c5,_4c6){
this.onurlinfo=new YAHOO.util.CustomEvent("onurlinfo",this,true);
_4c6.nocontainer=true;
maxwell.HtmlPlus.InputType.url.superclass.constructor.call(this,_4c5,_4c6);
this.icon=cn("img",{className:"favico",width:"16px",height:"16px",src:"http://us.i1.yimg.com/us.yimg.com/i/tb/iconsgif/blank.gif"});
maxwell.HtmlPlus.Util.manageInput(_4c5,"url");
YAHOO.util.Event.addListener(_4c5,"keypress",this.checkchange,this,true);
YAHOO.util.Event.addListener(_4c5,"blur",this.checkchange,this,true);
this.timer=true;
this.lasturl=null;
_4c5.parentNode.insertBefore(this.icon,_4c5);
};
...
var self=this;
ajaxCall("feed/preview",{"_out":"json","url":url},function(data){
...
sn(this.icon,{src:"http://us.i1.yimg.com/us.yimg.com/i/tb/iconsgif/blank.gif"});
}
};
maxwell.HtmlPlus.InputType.url.prototype.badurl=function(_4cd){
this.input.setAttribute("title","Unable to resolve URL "+_4cd);
this.icon.setAttribute("src","http://us.i1.yimg.com/us.yimg.com/i/us/fi/yfc/images/error_images/warning_1.1.gif");
};
...
maxwell.HtmlPlus.InputType.datetime=function(_4cf,_4d0){
maxwell.HtmlPlus.InputType.datetime.superclass.constructor.call(this,_4cf,_4d0);
...
maxwell.HtmlPlus.InputType.datetime.prototype.beforeOpen=function(_4d1){
if(!this.cal){
...
maxwell.HtmlPlus.InputType.datetime.prototype.handleSelect=function(type,args,obj){
var _4dd=args[0];
var date=_4dd[0];
var year=date[0],_4e0=date[1],day=date[2];
this.setInputValue({value:_4e0+"/"+day+"/"+year});
this.close();
this.hasFocus=false;
this.onchangefocus.fire(this.hasFocus);
};
$namespace("maxwell.HtmlPlus.InputType.location");
maxwell.HtmlPlus.InputType.location=function(_4e2,_4e3){
_4e3.nocontainer=true;
maxwell.HtmlPlus.InputType.location.superclass.constructor.call(this,_4e2,_4e3);
...
maxwell.HtmlPlus.InputType.module=function(_4e4,_4e5){
_4e5.nocontainer=true;
_4e5.notwirable=true;
maxwell.HtmlPlus.InputType.module.superclass.constructor.call(this,_4e4,_4e5);
...
this.moduleholder=cn("div",{className:"moduleholder"},null,this.inviteText);
maxwell.Util.insertAfter(this.moduleholder,this.input);
maxwell.Util.insertAfter(cn("br"),this.input);
var _4e6=["system:sources","rssmodule","system:my pipes"];
if(_4e4.getAttribute("moduletype")=="all"){
_4e6=["system:sources","rssmodule","system:my pipes","system:favorites","system:item","system:date","system:number","system:location","system:string","system:url"];
}
var dd=new maxwell.DragDrop.Target($id(this.moduleholder),_4e6);
dd.onSourceDragDrop.subscribe(function(type,args,me){
var _4eb=args[0];
var _4ec=null;
if(_4eb.hasDataType("moduletype")){
var _4ed=args[0].getData();
this.addSubModule(_4ed);
}else{
var _4ee=_4eb.getData();
if(_4ee.source=="pipe"){
this.addSubModule(_4ee.type);
}else{
var conf={"URL":{type:"url",value:_4ee.url}};
...
maxwell.HtmlPlus.InputType.module.prototype.initSubwalker=function(type,args,self){
this.m.walker.createCustomInput=function(node){
var _500={module:self.module,editable:true};
var inp=maxwell.HtmlPlus.CreateEx("editablefield",node,_500);
...
maxwell.HtmlPlus.InputType.module.prototype.addSubModule=function(type,conf,id){
if(this.m){
this.clearModule();
}
if(!this.module){
...
var m=maxwell.Module.Create(type,{conf:conf,isSubContent:true,id:id,style:{visibility:"hidden"}});
...
var _508=val.value;
if(_508){
this.addSubModule(_508.type,_508.conf,_508.id);
return true;
}
return false;
};
$namespace("maxwell.HtmlPlus.InputType.text");
maxwell.HtmlPlus.InputType.text=function(_509,_50a){
_50a.nocontainer=true;
maxwell.HtmlPlus.InputType.text.superclass.constructor.call(this,_509,_50a);
...
maxwell.HtmlPlus.InputType._private=function(_50b,_50c){
_50c.nocontainer=true;
maxwell.HtmlPlus.InputType._private.superclass.constructor.call(this,_50b,_50c);
maxwell.HtmlPlus.Util.manageInput(this.input,"text");
};
$extend(maxwell.HtmlPlus.InputType._private,maxwell.HtmlPlus.WirableInput);
$namespace("maxwell.RSSDebugger");
maxwell.RSSDebugger=function(_50d){
this.editor=_50d;
this.node=cn("div",{className:"rsspreview"},{height:"200px"});
this.title=cn("div",{className:"rsspreviewtitle"});
this.refreshingImage=cn("div",{className:"refreshing"},{display:"none"});
this.tab=cn("div",{className:"debugtabmain"},null,"<ul class='itemlist'></ul><span class='debugdebug'>Debugger:</span><span class='itemtitle'><i>none</i></span><span class='itemcount' style='display:none'></span><div class='debugtableft'></div><div class='debugtabright'>");
var _50e=this.tab.getElementsByTagName("span");
this.itemCount=_50e[2];
this.itemTitle=_50e[1];
...
this.errors=cn("ul",{className:"errorlist"},{display:"none"});
this.node.appendChild(this.errors);
this.node.appendChild(tmp);
this.treeNode=tmp.getElementsByTagName("td")[0];
this.buildTitle();
_50d.layout.onnewblock.subscribe(this.onnewblock,this,true);
_50d.layout.onremoveblock.subscribe(this.onremoveblock,this,true);
...
this.anim=new YAHOO.util.Anim(this.select,{height:{to:h}},0.2,YAHOO.util.Easing.easeOut);
this.anim.animate();
}
},this,true);
...
var _516=li.getAttribute("mid");
var m=this.editor.getModuleById(_516);
m.select();
},this,true);
};
maxwell.RSSDebugger.prototype.setSplitter=function(_518){
_518.node.appendChild(this.tab);
...
var _51d=args[0];
_51d.onready.subscribe(function(){
var li=cn("li",{mid:_51d.id},null,_51d.def.name);
this.select.appendChild(li);
},this,true);
};
maxwell.RSSDebugger.prototype.onremoveblock=function(type,args,self){
var _522=args[0];
var _523=this.select.getElementsByTagName("li");
for(var i=0;i<_523.length;i++){
if(_523[i].getAttribute("mid")==_522.id){
this.select.removeChild(_523[i]);
return;
}
}
};
...
if(!this.module){
try{
this.setSourceModule(this.editor.getModuleByType("output").terminals[0].wires[0].src.block);
}
catch(ex){
}
}
...
this.timeTaken=cn("span",{className:"timetaken"},{display:"none"});
this.refreshButton=cn("span",{className:"refresh"},{display:"none"},"Refresh");
this.title.appendChild(this.timeTaken);
this.title.appendChild(this.refreshButton);
YAHOO.util.Event.addListener(this.refreshButton,"click",this.refresh,this,true);
...
maxwell.RSSDebugger.prototype.setItemCount=function(_529){
if(!_529){
_529=0;
}
var t="(<span>"+_529+"</span> item";
if(_529!=1){
t+="s)";
}else{
t+=")";
...
maxwell.RSSDebugger.prototype.setSourceModule=function(_52b,_52c){
if(this.module){
this.module.onpreviewstart.unsubscribe(this.previewstart,this,true);
this.module.onpreviewavailable.unsubscribe(this.previewavailable,this,true);
}
this.module=_52b;
this.itemTitle.innerHTML=_52b.def.name;
this.tabshim.rsize(this.tabshim);
...
if((_52b.previewData||_52b.errorData)&&!_52b.dirty&&!_52c){
this.tree.clear();
this.render(_52b.previewData,_52b.errorData);
}else{
this.refresh();
}
};
...
if(type=="string"&&(data.indexOf("<br")>=0||data.indexOf("<a")>=0||data.indexOf("<img")>=0||data.indexOf("<p")>=0||data.indexOf("<div")>0)){
return true;
}
return false;
};
...
maxwell.RSSDebugger.prototype.render=function(rss,_538){
this.count=0;
if(rss){
this.constructBranch(this.tree.root,rss.items);
if(rss.items&&rss.items.length<rss.item_count){
this.tree.addNode(this.tree.root,this.tree.createNode("<p>+"+(rss.item_count-rss.items.length)+" more...</p>"));
}
...
if(!_548||typeof (_548)!="string"){
_548=key;
}
_548=_548.replace(/&quot;/g,"\"");
_548=_548.replace(/&#39;/g,"'");
var node=this.tree.createNode(cook(_548),key,true);
this.tree.addNode(root,node);
this.count++;
continue;
}
var _54a=typeof (data[key]);
var _54b=data[key];
var _54c=this.isHTML(_54b);
var _54d=this.isLargeText(_54b);
var _54e=(!_54b||(!(_54a=="object"||_54c||_54d)));
if(_54e){
key=key.replace(/&quot;/g,"\"");
key=key.replace(/&#39;/g,"'");
var txt="<span class='name'>"+cook(key)+"</span><span class='value "+typeof (_54b)+"'>"+cook(_54b)+"</span>";
...
var node=null;
if(this.isHTML(data)){
var _551=this.htmlEncode(data,true,0);
var _552="<span class='htmlsubkey'>[<a class='selected'>html</a>|<a>source</a>]</span>";
_552+="<div class=\"htmlholder\"></div>";
_552+="<div class=\"htmlholder source unselected\"></div>";
node=this.tree.createNode(_552);
this.tree.addNode(root,node);
var self=this;
window.setTimeout(function(){
...
var _552="<div class=\"textholder\">"+this.htmlEncode(data,true,0)+"</div>";
node=this.tree.createNode(_552);
this.tree.addNode(root,node);
}else{
...
maxwell.RSSDebugger.prototype.renderErrors=function(_55a){
if(_55a&&_55a.length>0){
...
var html="<img src='http://us.i1.yimg.com/us.yimg.com/i/space.gif' /><span>"+err.message+"</span>";
var li=cn("li",{className:"error "+err.type},{},html);
this.errors.appendChild(li);
}
};
maxwell.RSSDebugger.prototype.htmlEncode=function(_55f,_560,tabs){
function special(_562){
var _563="";
...
var c=line.charAt(p);
if(c==="\t"){
var _56d=tabs-(_56a.length%tabs);
for(var s=0;s<_56d;s++){
_56a+=" ";
}
}else{
_56a+=c;
...
_570=_570.replace(new RegExp("\"","g"),"&quot;");
}
_570=special(_570);
return _570;
};
...
this.modules=[];
this.inputs=[];
this.onnewlibrarymodule=new YAHOO.util.CustomEvent("onnewlibrarymodule",this);
this.node=cn("div",{className:"toolbox"});
this.librarynode=cn("div",{className:"librarymodules"});
this.helpnode=cn("div",{className:"helparea"},null,"<div class='helpcontainer'></div>");
this.helpcontainer=this.helpnode.firstChild;
this.accordion=new maxwell.Accordion($id(this.librarynode),[],maxwell.Accordion.LAYOUT_VERT);
this.node.appendChild(this.librarynode);
this.node.appendChild(this.helpnode);
this.splitter=new maxwell.Splitter.TopBottom(this.librarynode,this.helpnode,"smalltopbottom");
...
var _574=args[0];
var node=this.accordion.section_list[_574].title;
...
var _579=args[0];
var node=this.accordion.section_list[_579].title;
YAHOO.util.Dom.removeClass(node,"hide");
YAHOO.util.Dom.addClass(node,"show");
},this,true);
};
// cmr - change main categories
//maxwell.ModuleLibrary.categories=["Sources","User inputs","Operators","Url","String","Date","Location","Number","Favorites","My pipes","Deprecated"];
...
ajaxCall("module/list",{"_out":"json"},function(_57d){
_57d=_57d.module;
for(var i in _57d){
self.addModule(_57d[i]);
}
var _57f=self.accordion.findSectionByTitle("My pipes");
var _580=self.accordion.getSection(_57f);
var _581=(_580.content.childNodes.length>0);
var _582={tags:["system:My pipes"],name:"Insert new pipe",description:"Add a new sub-pipe into this pipe, and start editing it",type:"pipe:new"};
self.addModule(_582,true);
self.accordion.openSection(0);
if(!_581&&is_new_editor){
ajaxCall("module/featured",{"_out":"json"},function(data){
new maxwell.Dialog.Draggable({content:"Welcome to the Pipes editor",body:"<div class='module_featured'>"+data.description+"</div>"});
},function(_584){
});
}
},function(_585){
new maxwell.Dialog.Alert({content:"System Error",title:_585});
});
};
maxwell.ModuleLibrary.createLibraryModule=function(name,_587,_588){
var m=cn("div",{className:"librarymodule "+_588},null,"<div class='librarymodulecontent'>"+name+"</div><div class='librarymoduleleft'></div><div class='librarymoduleright'></div><div class='librarymodulefade'></div>");
m.setAttribute("title",_587);
return m;
};
maxwell.ModuleLibrary.prototype.addModule=function(_58a,_58b){
this.modules[_58a.type]=_58a;
var _58c="other";
if(!_58a.tags){
return;
}
if(this.isDeprecated(_58a)){
_58c="Deprecated";
}else{
for(var i=0;i<_58a.tags.length;i++){
if(_58a.tags[i].indexOf("system:")==0){
_58c=_58a.tags[i].substring(7,8).toUpperCase()+_58a.tags[i].substring(8);
break;
}
}
}
var _58e=_58c.replace(/\s+/g,"");
var m=maxwell.ModuleLibrary.createLibraryModule(_58a.name,_58a.description,_58e);
YAHOO.util.Event.addListener(m,"click",function(){
this.showHelp(_58a.type);
},this,true);
var _590=this.accordion.findSectionByTitle(_58c);
if(_590==null){
var _591=this.accordion.appendSection(_58c,m);
YAHOO.util.Dom.addClass(_591.title,"show");
}else{
var _591=this.accordion.getSection(_590);
var node=_591.content;
var _593=(node.childNodes.length==0);
if(_593){
YAHOO.util.Dom.addClass(_591.title,"show");
}
if(!_58b||_593){
...
_58a.node=m;
this.onnewlibrarymodule.fire(_58a);
};
maxwell.ModuleLibrary.prototype.help={};
maxwell.ModuleLibrary.prototype.showHelp=function(type,_595){
if(this.help[type]){
this.setHelpText(this.help[type],_595);
return;
}
var self=this;
ajaxCall("module/help",{"type":type,"_out":"json"},function(data){
self.help[data.type]=data.help;
self.setHelpText(data.help,_595);
},function(_598){
this.setHelpText("",_595);
});
};
maxwell.ModuleLibrary.prototype.setHelpText=function(txt,_59a){
...
if(!_59b){
var _59c=YAHOO.util.Dom.getStyle(this.splitter.nodeB,"backgroundColor");
var anim=new YAHOO.util.ColorAnim(this.splitter.nodeB,{backgroundColor:{to:"rgb(255, 255, 100)"}},0.3);
var _59e=new YAHOO.util.ColorAnim(this.splitter.nodeB,{backgroundColor:{to:_59c}},0.3);
anim.onComplete.subscribe(function(){
_59e.animate();
},this,true);
anim.animate();
...
maxwell.ModuleLibrary.prototype.isDeprecated=function(_59f){
for(var i=0;i<_59f.tags.length;i++){
if(_59f.tags[i]==("system:deprecated")){
return true;
}
}
return false;
...
maxwell.PropertiesDialog=function(_5a1){
...
html+="</tbody></table>";
var _5a3="<table cellspacing=0 cellpadding=0><tbody>";
_5a3+="<tr><td><label>Tags</label></td></tr>";
_5a3+="<tr class='pipetags'><td></td></tr>";
if(_5a1.pipe.id){
var pid=_5a1.pipe.id;
var _5a5="/pipes/pipe.info?_id="+pid;
var _5a6="_run"+pid;
var a="<a class='runpipe' target='+runid+' href='"+_5a5+"'>Run Pipe...</a>";
_5a3+="<tr  style='display:block;position:relative;padding-top:8px'><td>"+a+"</td></tr>";
if(_5a1.dirty){
_5a3+="<tr style='display:block;position:relative;padding-top:4px'><td><span>Note: this Pipe's changes are unsaved. The results displayed on the Pipe's run page may differ</span></td></tr>";
}
}
_5a3+="</tbody></table>";
var self=this;
var _5a9=new maxwell.Dialog.OkCancel({className:"pipeinfotab",canceltext:"Cancel",oktext:"OK",body:_5a3,content:html,onOk:function(){
self.ok(false);
}});
if(_5a1.pipe.is_owner){
var _5aa=maxwell.Toolbar.createBigButton("Publish&hellip;");
maxwell.Util.insertAfter(_5aa,_5a9.buttons.firstChild.firstChild);
YAHOO.util.Event.addListener(_5aa,"click",function(){
_5a9.remove();
var d2=new maxwell.Dialog.OkCancel({canceltext:"Cancel",oktext:"Publish",content:"By publishing this Pipe, it will be publicly listed on pipes.yahoo.com. Would you like to do this?",onOk:function(){
self.ok(true);
}});
});
}
var tds=_5a9.node.getElementsByTagName("TD");
var ta=_5a9.node.getElementsByTagName("TEXTAREA");
...
maxwell.PropertiesDialog.prototype.ok=function(_5af){
...
maxwell.PipesEditor._instance.tabs.onchangetitle.fire(this.editor,this.name.value);
}
};
...
this.modules=[];
this.inputs=[];
this.node=cn("div",{className:"searchholder"},null,"<div class='searchbar'><input type='text' autocomplete='off'/><div class='search'></div></div><div class='searchMatches'><ul></ul><div class='searchStatus'><span></span></div></div>");
...
var _5b0=maxwell.Toolbar.createSmallButton("Close").firstChild;
YAHOO.util.Dom.addClass(_5b0,"searchclose");
this.status.appendChild(_5b0);
this.inputBox=this.node.getElementsByTagName("input")[0];
this.progress=cn("div",{className:"refreshing"},{display:"none",top:"-12px"});
this.status.appendChild(this.progress);
this.searchresults.style.display="none";
maxwell.HtmlPlus.Util.manageInput(this.inputBox,"Search for pipes and feeds");
YAHOO.util.Event.addListener(this.inputBox.nextSibling,"click",this.doSearch,this,true);
YAHOO.util.Event.addListener(this.inputBox,"focus",this.open,this,true);
YAHOO.util.Event.addListener(this.inputBox,"keydown",this.clear,this,true);
YAHOO.util.Event.addListener(_5b0,"click",this.close,this,true);
...
this.clear();
var self=this;
ajaxCall("feed/find",{"_out":"json","query":this.inputBox.value},function(data){
self.doingSearch=false;
var _5bf=data.result.length;
self.onfinish.fire(_5bf);
if(_5bf==0){
return;
}
...
self.onerror.fire(_5c2);
});
return true;
};
maxwell.SearchDropDown.prototype.formatResult=function(_5c3){
var node=cn("li");
var m=maxwell.ModuleLibrary.createLibraryModule(_5c3.name,_5c3.description,_5c3.type);
node.appendChild(m);
this.results.appendChild(node);
var rid=$id(m);
YAHOO.util.Event.onAvailable(rid,function(){
var _5c7=new maxwell.DragDrop.Source(rid,_5c3,["rssmodule"]);
var _5c8=m.getElementsByTagName("div")[1];
YAHOO.util.Event.addListener(_5c8,"click",function(){
var _5c9=maxwell.PipesEditor.CurrentEditor();
var xy=[250,250];
_5c9.layoutTarget.onSourceDragDrop.fire(_5c7,xy);
},_5c7,true);
});
};
$namespace("maxwell.Accordion");
maxwell.Accordion=function(_5cb,_5cc,_5cd){
if(arguments.length==0){
return;
}
this.enclosure=_5cb;
this.title_list=_5cc;
this.horizontal=_5cd;
...
maxwell.Accordion.is_ie=(maxwell.Accordion.agent.indexOf("msie")!=-1&&maxwell.Accordion.agent.indexOf("opera")==-1);
...
this.section_list=[];
var _5cf=this.title_list.length;
for(var i=0;i<_5cf;i++){
this.appendSection(this.title_list[i]);
}
this.title_list=null;
this.onInit.fire();
};
maxwell.Accordion.prototype.setAnimation=function(_5d1,_5d2){
this.slide_time=_5d1;
this.slide_easing=_5d2;
};
maxwell.Accordion.prototype.willAllowMultipleOpenSections=function(){
return this.allow_multiple_open;
};
maxwell.Accordion.prototype.shouldAllowMultipleOpenSections=function(_5d3){
this.allow_multiple_open=_5d3;
if(!_5d3){
...
maxwell.Accordion.prototype.shouldAllowAllSectionsClosed=function(_5d4){
this.allow_all_closed=_5d4;
if(!_5d4&&this.allSectionsClosed()){
this.toggleContent(0);
}
};
maxwell.Accordion.prototype.getTitle=function(_5d5){
return this.section_list[_5d5].title;
};
maxwell.Accordion.prototype.setTitle=function(_5d6,_5d7){
var t=this.section_list[_5d6].title;
...
maxwell.Accordion.prototype.getSection=function(_5d9){
return this.section_list[_5d9];
};
maxwell.Accordion.prototype.setSection=function(_5da,_5db){
var d=this.section_list[_5da].content;
...
maxwell.Accordion.prototype.prependSection=function(_5dd,_5de){
return this.insertSection(0,_5dd,_5de);
};
maxwell.Accordion.prototype.appendSection=function(_5df,_5e0){
return this.insertSection(this.section_list.length,_5df,_5e0);
};
maxwell.Accordion.prototype.insertSection=function(_5e1,_5e2,_5e3){
var t=document.createElement("div");
YAHOO.util.Dom.addClass(t,this.title_class);
var c=document.createElement("div");
YAHOO.util.Dom.addClass(c,this.content_clip_class);
YAHOO.util.Dom.setStyle(c,this.slide_style_name,maxwell.Accordion.min_size+"px");
...
c.appendChild(d);
this.section_list.splice(_5e1,0,{title:t,clip:c,content:d,open:false});
if(_5e2){
this.setTitle(_5e1,_5e2);
}
if(_5e1<this.section_list.length-1){
this.container.insertBefore(t,this.section_list[_5e1+1].title);
}else{
this.container.appendChild(t);
}
var size=t[this.slide_size_name];
YAHOO.util.Dom.setStyle(t,this.slide_style_name,maxwell.Accordion.min_size+"px");
var _5e8={opacity:{from:0,to:1}};
_5e8[this.slide_style_name]={to:size};
var anim=new YAHOO.util.Anim(t,_5e8,this.slide_time,this.slide_easing);
anim.animate();
YAHOO.util.Event.addListener(t,"click",this.onTitleClicked,this,true);
if(_5e3){
this.setSection(_5e1,_5e3);
}
if(_5e1<this.section_list.length-1){
this.container.insertBefore(c,this.section_list[_5e1+1].title);
}else{
...
maxwell.Accordion.prototype.deleteSection=function(_5eb){
var _5ec={opacity:{from:1,to:0}};
_5ec[this.slide_style_name]={to:maxwell.Accordion.min_size};
if(this.section_list[_5eb].open){
var anim=new YAHOO.util.Anim(this.section_list[_5eb].clip,_5ec,this.slide_time,this.slide_easing);
anim.animate();
}
var anim=new YAHOO.util.Anim(this.section_list[_5eb].title,_5ec,this.slide_time,this.slide_easing);
anim.onComplete.subscribe(function(type,_5ef,_5f0){
_5f0[0].removeChild(_5f0[1]);
_5f0[0].removeChild(_5f0[2]);
},[this.container,this.section_list[_5eb].title,this.section_list[_5eb].clip]);
anim.animate();
this.section_list.splice(_5eb,1);
if(!this.allow_all_closed&&this.allSectionsClosed()){
this.toggleContent(0);
}
};
maxwell.Accordion.prototype.findSection=function(_5f1){
var _5f2=this.section_list.length;
for(var i=0;i<_5f2;i++){
if(this.section_list[i].content==_5f1){
return i;
}
}
return null;
};
maxwell.Accordion.prototype.findSectionByTitle=function(_5f4){
var _5f5=this.section_list.length;
for(var i=0;i<_5f5;i++){
if(this.section_list[i].title.innerHTML==_5f4){
return i;
}
}
return null;
};
maxwell.Accordion.prototype.sectionIsOpen=function(_5f7){
return this.section_list[_5f7].open;
};
maxwell.Accordion.prototype.openSection=function(_5f8){
if(!this.section_list[_5f8].open){
this.toggleContent(_5f8);
}
};
maxwell.Accordion.prototype.closeSection=function(_5f9){
if(this.section_list[_5f9].open){
this.toggleContent(_5f9);
}
};
maxwell.Accordion.prototype.allSectionsClosed=function(){
var _5fa=this.section_list.length;
for(var i=0;i<_5fa;i++){
...
maxwell.Accordion.prototype.setHandler=function(_5fc,_5fd){
this.section_list[_5fc].handler=_5fd;
if(_5fd&&_5fd.init&&typeof _5fd.init=="function"){
_5fd.init(this,_5fc);
}
};
maxwell.Accordion.prototype.onTitleClicked=function(e){
var t=YAHOO.util.Event.getTarget(e);
var _600=this.section_list.length;
for(var i=0;i<_600;i++){
...
maxwell.Accordion.prototype.toggleContent=function(_602){
if(!this.section_list[_602].open&&!this.allow_multiple_open){
var save=this.allow_all_closed;
this.allow_all_closed=true;
this.closeAllSections();
this.allow_all_closed=save;
}else{
if(this.section_list[_602].open&&!this.allow_all_closed){
this.section_list[_602].open=false;
if(this.allSectionsClosed()){
this.section_list[_602].open=true;
return;
}
this.section_list[_602].open=true;
}
}
if(!this.section_list[_602].open){
YAHOO.util.Dom.setStyle(this.section_list[_602].content,"display","block");
this.onBeforeOpen.fire(_602);
var h=this.section_list[_602].handler;
if(h&&h.onShow&&typeof h.onShow=="function"){
h.onShow();
}
var size=this.section_list[_602].content[this.slide_size_name];
var _606={opacity:{from:0,to:1}};
_606[this.slide_style_name]={to:size};
var anim=new YAHOO.util.Anim(this.section_list[_602].clip,_606,this.slide_time,this.slide_easing);
anim.onComplete.subscribe(function(type,_609,_60a){
_60a[0].onAfterOpen.fire(_60a[1]);
},[this,_602]);
anim.animate();
this.section_list[_602].open=true;
}else{
this.onBeforeClose.fire(_602);
var _606={opacity:{from:1,to:0}};
_606[this.slide_style_name]={to:maxwell.Accordion.min_size};
var anim=new YAHOO.util.Anim(this.section_list[_602].clip,_606,this.slide_time,this.slide_easing);
anim.onComplete.subscribe(function(type,_60c,_60d){
YAHOO.util.Dom.setStyle(_60d[2],"display","none");
_60d[0].onAfterClose.fire(_60d[1]);
if(_60d[3]&&_60d[3].onShow&&typeof _60d[3].onShow=="function"){
_60d[3].onHide();
}
},[this,_602,this.section_list[_602].content,this.section_list[_602].handler]);
anim.animate();
this.section_list[_602].open=false;
}
};
maxwell.Accordion.prototype.closeAllSections=function(){
var _60e=this.section_list.length;
var _60f=true;
for(var i=0;i<_60e;i++){
if(this.section_list[i].open){
if(!this.allow_all_closed&&_60f){
_60f=false;
}else{
this.toggleContent(i);
}
...
this.node=cn("div",{className:"wiretool"},{},"<span></span>");
this.updateType(t.config.types);
this.img=cn("div",{className:"wiretoolcut"},{display:"none"});
this.node.appendChild(this.img);
this.terminal.ontypechange.subscribe(function(type,args,self){
this.updateType([args[0]]);
},this,true);
YAHOO.util.Event.addListener(this.img,"click",this.removeLine,this,true);
this.node.style.display="none";
...
YAHOO.util.Event.addListener(t.node,"mouseover",this.showMenu,this,true);
YAHOO.util.Event.addListener(this.node,"mouseover",this.showMenu,this,true);
...
maxwell.TerminalMenu.prototype.updateType=function(_61f){
if(!_61f||_61f.length==0||!_61f[0]){
...
YAHOO.util.Event.addListener(wire.node,"mouseover",this.showNoMenu,this,true);
...
maxwell.TerminalMenu.prototype.show=function(_626){
this.showMenu=_626;
if(this.hideTimeout){
...
YAHOO.util.Dom.setXY(self.node,[xy[0]+self.terminal.direction[0]*20-(self.node.offsetWidth/2),xy[1]+self.terminal.direction[1]*20-(self.node.offsetHeight/2)]);
}
self.setOpacity(0.7);
},500);
};
...
if(v==1){
var b=new YAHOO.util.Anim(n,{opacity:{to:1}},0.3,YAHOO.util.Easing.easeOut);
...
var b=new YAHOO.util.Anim(n,{opacity:{to:v}},0.3,YAHOO.util.Easing.easeIn);
b.animate();
}
};
f(a,v);
...
if(!node){
this.node=cn("div",{className:"simpletree"});
this.root=cn("ul",{className:"root"});
...
maxwell.SimpleTree.prototype.click=function(_639){
var el=YAHOO.util.Event.getTarget(_639,true);
...
YAHOO.util.Event.stopEvent(_639);
};
...
maxwell.SimpleTree.prototype.createNode=function(_642,key,_644){
var _645={};
if(typeof (key)!="undefined"&&key!=null){
_645["key"]=""+key;
}
if(_644){
_645["className"]="branch closed";
}
var n=cn("li",_645,{},"<span>"+_642+"</span>");
if(_644){
n.appendChild(cn("ul",{className:"closed"},{}));
}
return n;
};
maxwell.SimpleTree.prototype.addNode=function(_647,node){
if(_647.tagName=="LI"){
if(YAHOO.util.Dom.hasClass(_647,"branch")){
_647=_647.getElementsByTagName("ul")[0];
}else{
var _649=cn("ul",{className:"closed"},{});
_647.appendChild(_649);
YAHOO.util.Dom.addClass(_647,"branch");
YAHOO.util.Dom.addClass(_647,"closed");
_647=_649;
}
}
_647.appendChild(node);
};
$namespace("maxwell.Dialog");
maxwell.Dialog=function(_64a,_64b){
if(!_64a){
_64a={content:""};
}else{
...
this.config=_64a;
this.node=cn("div",{className:"dialog"},{zIndex:9999,position:"absolute",visibility:"hidden"},"<div class='dialogheader'></div><div class='dialogbody'></div><div class='dialogfooter'>");
if(_64a.className){
YAHOO.util.Dom.addClass(this.node,_64a.className);
}
...
if(typeof (_64a.body)=="string"){
this.body.innerHTML=_64a.body;
}else{
this.body.appendChild(_64a.body);
}
...
if(typeof (_64a.content)=="string"){
this.header.innerHTML=_64a.content;
}else{
this.header.appendChild(_64a.content);
}
var _64d={};
if(_64b){
_64d=YAHOO.util.Dom.getRegion(_64b);
}else{
_64d={left:0,top:0,bottom:YAHOO.util.Dom.getViewportHeight(),right:YAHOO.util.Dom.getViewportWidth()};
_64b=document.body;
}
YAHOO.util.Dom.setStyle(this.node,"opacity",0);
_64b.appendChild(this.node);
if(!_64a.noBackground){
if(!_64a.bgcolor){
_64a.bgcolor="#202020";
}
var _64e={className:"dialogbg",width:(_64d.right-_64d.left)+"px",height:(_64d.bottom-_64d.top)+"px"};
var _64f={textAlign:"center",verticalAlign:"middle",backgroundColor:_64a.bgcolor,border:"0px",margin:"0px",padding:"0px",display:"block",position:"absolute",zIndex:9998,left:_64d.left+"px",top:_64d.top+"px",width:_64e.width,height:_64e.height};
this.bgnode=cn("div",_64e,_64f);
if(maxwell.Util.ua.isIE){
_64f.filter="alpha(opacity=0)";
_64f.zIndex=1;
var _650=cn("iframe",_64e,_64f);
this.bgnode.appendChild(_650);
}
YAHOO.util.Dom.setStyle(this.bgnode,"opacity",0.3);
_64b.appendChild(this.bgnode);
}
if(!_64a.position){
YAHOO.util.Dom.setXY(this.node,[(_64d.right-_64d.left-this.node.offsetWidth)/2,(_64d.bottom-_64d.top-this.node.offsetHeight)/2]);
}else{
sn(this.node,null,{top:"16px",right:"16px"});
}
this.node.style.visibility="visible";
this.display();
};
...
this.anim2=new YAHOO.util.Anim(this.node,{opacity:{to:1}},0.3,YAHOO.util.Easing.easeOut);
if(this.bgnode){
this.anim1=new YAHOO.util.Anim(this.bgnode,{opacity:{to:0.3}},0.3,YAHOO.util.Easing.easeOut);
this.anim1.animate();
}
this.anim2.animate();
};
...
this.anim2=new YAHOO.util.Anim(this.node,{opacity:{to:0}},0.3,YAHOO.util.Easing.easeIn);
if(this.bgnode){
this.anim1=new YAHOO.util.Anim(this.bgnode,{opacity:{to:0}},0.3,YAHOO.util.Easing.easeIn);
...
maxwell.Dialog.Alert=function(_657,_658){
maxwell.Dialog.Alert.superclass.constructor.call(this,_657,_658);
this.header.style.fontWeight="bold";
if(!_657.oktext){
_657.oktext="OK";
}
var _659=cn("div",{className:"dialogbuttons"},null,"<ul></ul>");
this.okButton=maxwell.Toolbar.createBigButton(_657.oktext);
_659.firstChild.appendChild(this.okButton);
this.body.appendChild(_659);
this.body.style.display="block";
this.okButton.focus();
...
maxwell.Dialog.OkCancel=function(_65a,_65b){
maxwell.Dialog.OkCancel.superclass.constructor.call(this,_65a,_65b);
if(!_65a.oktext){
_65a.oktext="OK";
}
if(!_65a.canceltext){
_65a.canceltext="Cancel";
}
var _65c=cn("div",{className:"dialogbuttons"},null,"<ul></ul>");
this.okButton=maxwell.Toolbar.createBigButton(_65a.oktext);
this.cancelButton=maxwell.Toolbar.createBigButton(_65a.canceltext);
this.buttons=_65c;
_65c.firstChild.appendChild(this.okButton);
_65c.firstChild.appendChild(this.cancelButton);
this.body.appendChild(_65c);
this.body.style.display="block";
YAHOO.util.Event.addListener(this.okButton,"click",function(){
this.remove();
if(_65a.onOk){
...
maxwell.Dialog.Draggable=function(_65d,_65e){
if(!_65d){
_65d={};
}
if(!_65d.className){
_65d.className="dialogdraggable";
}else{
_65d.className+=" dialogdraggable";
}
_65d.noBackground=true;
maxwell.Dialog.Draggable.superclass.constructor.call(this,_65d,_65e);
this.closeButton=cn("div",{className:"closebutton"});
...
this.dd.onMouseUp=function(_661){
document.body.ondrag=null;
document.body.onselectstart=null;
};
}
...
maxwell.Dialog.Iframe=function(_662,_663){
if(!_662){
_662={};
}
if(!_662.className){
_662.className="dialogiframe";
}
if(!_662.url){
_662.url="about:blank";
}else{
if(maxwell.Util.ua.isSafari&&_662.url[0]=="/"){
_662.url=window.location.protocol+"//"+window.location.host+_662.url;
}
}
_662.body="<iframe src=\""+_662.url+"\" frameborder=0 class=\"dialogiframebody\" />";
maxwell.Dialog.Iframe.superclass.constructor.call(this,_662,_663);
};
$extend(maxwell.Dialog.Iframe,maxwell.Dialog.Draggable);
maxwell.Dialog.Save=function(_664,_665){
_664.content="<h1>Pipe name:</h1><input type=text class='dialogsaveinput' /><div>";
_664.className="savedialog";
maxwell.Dialog.Save.superclass.constructor.call(this,_664,_665);
var _666=cn("div",{className:"dialogbuttons"},null,"<ul></ul>");
this.okButton=maxwell.Toolbar.createBigButton("Save");
this.cancelButton=maxwell.Toolbar.createBigButton("Cancel");
_666.firstChild.appendChild(this.okButton);
_666.firstChild.appendChild(this.cancelButton);
this.header.appendChild(_666);
...
YAHOO.util.Event.addListener(this.cancelButton,"click",this.onCancel,this,true);
};
...
maxwell.SimpleTooltip=function(_66a,tip,_66c){
if(!tip){
return;
}
this.target=_66a;
...
var _677=YAHOO.util.Dom.getRegion(this.target);
if(!xy){
xy=[(_677.left+_677.right)/2,(_677.top+_677.bottom)/2];
}else{
xy[1]=(_677.top+_677.bottom)/2;
}
if(!this.node){
...
return cn("div",{className:"simpletooltip"},{position:"absolute",display:"block",left:xy[0]+"px",top:xy[1]+"px"},this.tip);
};
maxwell.SimpleTooltip.prototype.positionNode=function(xy){
sn(this.node,null,{left:xy[0]+"px",top:xy[1]+"px",display:"block"});
};
...
maxwell.SimpleTooltip.prototype.config={hoverTime:1000};
$namespace("maxwell.LargeTooltip");
maxwell.LargeTooltip=function(_67c,_67d,_67e){
maxwell.LargeTooltip.superclass.constructor.call(this,_67c,_67d,_67e);
this.xdelta=20;
this.ydelta=-50;
this.maxw=168;
this.minw=168;
...
var node=cn("div",{className:"tooltipholder"},{marginLeft:"-10000px",zIndex:9998,position:"absolute",left:l+"px",top:t+"px"},"<div class='tooltipheader'></div><div class='tooltipbody'><iframe frameborder=0 class='tooltipframe' src='about:blank'></iframe></div><div class='tooltipfooter'></div>");
var _683=cn("div",{className:"tooltiparrow"},{zIndex:9999,position:"absolute",left:-this.xdelta+"px",top:-(this.ydelta+8)+"px"});
node.appendChild(_683);
this.iframe=node.getElementsByTagName("iframe")[0];
this.iframe.setAttribute("src",this.tip);
YAHOO.util.Event.onAvailable($id(this.iframe),this.getFrameInfo,this,true);
return node;
};
...
var l=xy[0]+this.xdelta;
var t=xy[1]+this.ydelta;
sn(this.node,null,{marginLeft:"-10000px",left:l+"px",top:t+"px",display:"block"});
sn(this.node.lastChild,null,{left:-this.xdelta+"px",top:-(this.ydelta+8)+"px"});
};
maxwell.LargeTooltip.prototype.doShow=function(xy){
var _689=maxwell.LargeTooltip.superclass.doShow.call(this,xy);
if(_689){
YAHOO.util.Event.addListener(document.body,"mouseover",this.docFocus,this,true);
YAHOO.util.Event.addListener(this.node,"mouseover",this.tipFocus,this,true);
this.getHeight();
}
if(this.iwin){
this.iwin.focus();
...
if(this.shown){
var a=YAHOO.util.Event.removeListener(document.body,"mouseover",this.docFocus);
var b=YAHOO.util.Event.removeListener(this.node,"mouseover",this.tipFocus);
...
var _690=this.node.offsetTop;
this.node.style.top="0px";
this.node.lastChild.style.top=this.node.lastChild.offsetTop+_690+"px";
}
if(this.node.offsetTop+this.node.offsetHeight>document.body.offsetHeight){
var _691=document.body.offsetHeight-this.node.offsetHeight;
var _690=this.node.offsetTop-_691;
this.node.style.top=_691+"px";
this.node.lastChild.style.top=this.node.lastChild.offsetTop+_690+"px";
}
this.shim.rsize(this.shim);
var a=new YAHOO.util.Anim(this.node,{opacity:{to:1}},0.25,YAHOO.util.Easing.easeOut);
a.animate();
};
maxwell.LargeTooltip.prototype.calcWH=function(win,doc){
var _695=0,sh,oh;
if(win.innerHeight&&win.scrollMaxY){
_695=win.innerHeight+win.scrollMaxY;
}else{
if(doc.height){
_695=doc.height;
}else{
...
_695=sh=doc.body.scrollHeight;
}
if(doc.body.offsetHeight){
_695=oh=doc.body.offsetHeight;
}
if(sh&&oh){
_695=Math.max(sh,oh);
}
...
_698=win.innerWidth+win.scrollMaxX;
}else{
if(doc.width){
_698=doc.width;
}else{
...
_698=sw=doc.body.scrollWidth;
}
if(doc.body.offsetWidth){
_698=ow=doc.body.offsetWidth;
}
if(sw&&ow){
_698=Math.max(sw,ow);
}
...
if(!node){
this.node=cn("div",{className:"taglist"});
}else{
this.node=node;
...
this.inputli=cn("li",null,null,"<input type=text><img class='add' src='http://us.i1.yimg.com/us.yimg.com/i/space.gif' width=16 height=16>");
this.input=this.inputli.firstChild;
this.ul.appendChild(this.inputli);
this.addTags(tags);
var self=this;
YAHOO.util.Event.addListener(self.input,"keydown",self.keydown,self,true);
YAHOO.util.Event.addListener(self.node,"click",self.click,self,true);
maxwell.HtmlPlus.Util.manageInput(this.input,"enter tag");
};
maxwell.Taglist.prototype.keydown=function(_69e){
var _69f=YAHOO.util.Event.getCharCode(_69e);
if(_69f==32||_69f==13){
this.addInputTag();
YAHOO.util.Event.stopEvent(_69e);
}
};
maxwell.Taglist.prototype.addInputTag=function(){
if(this.input.value.length>0&&!YAHOO.util.Dom.hasClass(this.input,"novalue")){
...
maxwell.Taglist.prototype.click=function(_6a1){
var el=YAHOO.util.Event.getTarget(_6a1,true);
if(el.tagName=="IMG"){
...
YAHOO.util.Event.stopEvent(_6a1);
}
};
maxwell.Taglist.prototype.addTags=function(tags){
for(var i=0;i<tags.length;i++){
if(!this.hasTag(tags[i])){
var li=cn("li",null,null,"<span>"+tags[i]+"</span><img class='del' src='http://us.i1.yimg.com/us.yimg.com/i/space.gif' width=16 height=16>");
...
maxwell.Splitter=function(_6aa,_6ab,_6ac){
if(!_6ac){
this.config={};
}else{
this.config=_6ac;
}
this.node=cn("div",{className:"splitter "+this.config.className},{display:"block",position:"absolute",zoom:"1"});
this.nodeA=_6aa;
this.nodeB=_6ab;
_6aa.parentNode.appendChild(this.node);
this.shown=true;
var tab=this.createTab();
if(tab){
this.node.appendChild(tab);
YAHOO.util.Event.addListener(tab.firstChild,"click",this.openclose,this,true);
}
};
...
maxwell.Splitter.Resize=function(_6ae,_6af,_6b0){
maxwell.Splitter.Resize.superclass.constructor.call(this,_6ae,_6af,_6b0);
var deid=$id(this.node.firstChild);
this.dd=new YAHOO.util.DD($id(this.node),"splitter");
this.dd.setOuterHandleElId(deid);
var self=this;
this.dd.onDrag=function(_6b3){
self.resizeAB();
};
...
YAHOO.util.DragDropMgr.refreshCache({splitter:true});
};
...
maxwell.Splitter.TopBottom=function(_6be,_6bf,_6c0){
this.nodeBadjust=null;
var _6c1={className:"topbottom"};
if(_6c0){
_6c1.className+=" "+_6c0;
}
sn(_6be,null,{position:"absolute",top:"0px",bottom:"auto",width:"100%",display:"block",zoom:"1",height:"75%"});
sn(_6bf,null,{position:"absolute",top:"auto",bottom:"0px",width:"100%",display:"block",zoom:"1"});
maxwell.Splitter.TopBottom.superclass.constructor.call(this,_6be,_6bf,_6c1);
...
var _6c5=this.parentNode.offsetHeight;
var _6c6=_6c5-top-this.node.offsetHeight;
this.calcPadding();
_6c6=_6c6-this.nodeBadjust;
if(_6c6<0){
_6c6=0;
}
if(top<0){
...
this.nodeB.style.height=_6c6+"px";
this.node.style.left="0px";
};
maxwell.Splitter.TopBottom.prototype.resizeAS=function(){
var _6c7=this.parentNode.offsetHeight;
var top=_6c7-this.nodeB.offsetHeight-this.node.offsetHeight;
if(top<0){
top=0;
}
...
return cn("div",{className:"sliderhoriz"},null,"<div class='horizbutton makemin'></div>");
};
...
return new YAHOO.util.Anim(this.nodeB,{height:{to:this.height}},0.2,YAHOO.util.Easing.easeOut);
};
maxwell.Splitter.TopBottom.prototype.createHideAnim=function(){
this.height=this.nodeB.offsetHeight;
return new YAHOO.util.Anim(this.nodeB,{height:{to:4}},0.2,YAHOO.util.Easing.easeIn);
};
$namespace("maxwell.Splitter.LeftRight");
maxwell.Splitter.LeftRight=function(_6c9,_6ca){
var _6cb={className:"leftright"};
sn(_6c9,null,{position:"absolute",left:"0px",right:"auto",height:"100%"});
sn(_6ca,null,{position:"absolute",left:"auto",right:"0px",height:"100%"});
maxwell.Splitter.LeftRight.superclass.constructor.call(this,_6c9,_6ca,_6cb);
...
var _6cd=this.node.parentNode.offsetWidth;
var _6ce=_6cd-left-this.node.offsetWidth;
this.nodeA.style.width=left+"px";
this.nodeB.style.width=_6ce+"px";
};
maxwell.Splitter.LeftRight.prototype.resizeAS=function(){
var _6cf=this.node.parentNode.offsetWidth;
var left=this.nodeA.offsetWidth;
var _6d1=_6cf-left-this.node.offsetWidth;
this.node.style.left=left+"px";
this.nodeB.style.width=_6d1+"px";
};
maxwell.Splitter.LeftRight.prototype.createTab=function(){
return cn("div",{className:"slidervert"},null,"<div class='vertbutton makemin'></div>");
};
...
return new YAHOO.util.Anim(this.nodeA,{width:{to:this.width}},0.2,YAHOO.util.Easing.easeOut);
};
maxwell.Splitter.LeftRight.prototype.createHideAnim=function(){
this.width=this.nodeA.offsetWidth;
return new YAHOO.util.Anim(this.nodeA,{width:{to:4}},0.2,YAHOO.util.Easing.easeIn);
};
$namespace("maxwell.Toolbar");
maxwell.Toolbar=function(){
this.node=cn("div",{className:"editbuttons"},null,"<ul class=\"leftset\"></ul><ul class=\"rightset\"></ul>");
this.onupdate=new YAHOO.util.CustomEvent("onupdate",this,true);
var _6d2=this.node.firstChild;
var _6d3=this.node.lastChild;
...
_6d2.appendChild(ex);
_6d2.appendChild(co);
var bb=cn("li",{className:"goback"},null,"<a href=\""+profileurl+"\">Back to My Pipes</a>");
...
return cn("li",null,null,"<div class='menusmallbutton'>"+text+"<div class='menusmallbuttonleft'></div><div class='menusmallbuttonright'></div></div>");
};
maxwell.Toolbar.createBigButton=function(text){
return cn("li",null,null,"<div class='menubigbutton'>"+text+"<div class='menubigbuttonleft'></div><div class='menubigbuttonright'></div></div>");
};
...
this.editor.onclonestart.unsubscribe(this.oneditorclonestart,this,true);
...
var _6e2=maxwell.PipesEditor.CurrentEditor();
if(_6e2.dirty){
_6e2.save();
}
};
maxwell.Toolbar.prototype.publish=function(){
var _6e3=maxwell.PipesEditor.CurrentEditor();
new maxwell.PropertiesDialog(maxwell.PipesEditor.CurrentEditor());
};
maxwell.Toolbar.prototype.clone=function(){
var _6e4=maxwell.PipesEditor.CurrentEditor();
if(!_6e4.pipe.id){
return;
}
_6e4.pipe.name="Copy of "+_6e4.pipe.name;
maxwell.PipesEditor.CurrentEditor().clone();
};
maxwell.Toolbar.prototype.maintainhash=function(){
var _6e5=maxwell.PipesEditor.CurrentEditor();
if(maxwell.PipesEditor._instance.editorIndex==0){
if(!maxwell.Util.ua.isSafari){
if(_6e5.pipe.id!=this.oldid){
window.location.hash=_6e5.pipe.id;
}
}
}
this.oldid=_6e5.pipe.id;
};
...
if(!args[0]){
new maxwell.Dialog.Alert({body:args[1],content:"Problem cloning"});
return;
}
this.maintainhash();
...
var _6ec=maxwell.PipesEditor.CurrentEditor();
if(this.saving){
this.saving.remove();
this.saving=null;
}
if(!args[0]){
new maxwell.Dialog.Alert({body:args[1],content:"Problem saving"});
return;
}
this.maintainhash();
this.update(_6ec);
...
var _6f0=maxwell.PipesEditor.CurrentEditor();
if(this.loading){
this.loading.remove();
this.loading=null;
}
if(!args[0]){
new maxwell.Dialog.Alert({body:args[1],content:"Problem loading"});
return;
}
this.update(_6f0);
maxwell.PipesEditor.SetRunPipeStatus("Pipe Loaded");
};
maxwell.Toolbar.prototype.update=function(_6f1){
if(!_6f1){
_6f1=maxwell.PipesEditor.CurrentEditor();
}
maxwell.PipesEditor.UpdatePipeName();
if(_6f1.pipe.name){
document.title="Pipes: editing '"+_6f1.pipe.name+"'";
}else{
...
this.onupdate.fire(_6f1);
};
maxwell.Toolbar.prototype.oneditorsavestart=function(type,args,self){
var _6f5="<div class='dialogwaitmsg'>Saving&hellip;</div>";
this.oldid=maxwell.PipesEditor.CurrentEditor().pipe.id;
this.saving=new maxwell.Dialog({content:_6f5,className:"statusdialog"});
};
maxwell.Toolbar.prototype.oneditorloadstart=function(type,args,self){
var _6f9=maxwell.PipesEditor.CurrentEditor().layout;
if(_6f9.invitearea){
_6f9.invitearea.parentNode.removeChild(_6f9.invitearea);
_6f9.invitearea=null;
}
var _6fa="<div class='dialogwaitmsg'>Loading&hellip;</div>";
this.loading=new maxwell.Dialog({content:_6fa,className:"statusdialog"});
};
maxwell.Toolbar.prototype.oneditorclonestart=function(type,args,self){
var _6fe="<div class='dialogwaitmsg'>Copying&hellip;</div>";
this.oldid=maxwell.PipesEditor.CurrentEditor().pipe.id;
this.cloning=new maxwell.Dialog({content:_6fe,className:"statusdialog"});
};
...
maxwell.InlineTextEdit=function(node,_703){
this.onchange=new YAHOO.util.CustomEvent("onchange",this,true);
...
result=YAHOO.util.Event.removeListener(this.input,"keydown",this.resize);
}
};
...
sn(this.input,{size:len});
};
maxwell.InlineTextEdit.prototype.init=function(){
if(!this.node){
this.node=cn("div",{className:"inlineedit"},null,"<input type=text>");
this.buttons=cn("div",{className:"inlineeditbuttons"},null,"<ul></ul>");
...
YAHOO.util.Event.addListener(this.input,"keydown",this.resize,this,true);
}
};
...
maxwell.PipesEditorTabs=function(_710){
...
this.node=cn("div",{className:"pipetabs"},null,"<a href=\""+profileurl+"\"><img  src=\"/images/logo_sm_1.gif\" /></a>");
this.tabsholder=cn("div",{className:"pipetabsholder"});
this.tabs=cn("ul",{className:"pipetabsul"});
this.tabsholder.appendChild(this.tabs);
this.node.appendChild(this.tabsholder);
this.shownTab=-1;
};
maxwell.PipesEditorTabs.prototype.updateTabText=function(_711,tab){
var _713=this._indexOfEditor(_711);
if(!tab){
tab=this.tabs.childNodes[_713];
}
var _714=tab.getElementsByTagName("span")[0];
var _715=tab.getElementsByTagName("b")[0];
var name=_711.pipe.name;
if(!name||name.length==0){
name="untitled";
}
_714.innerHTML=cook(name);
if(_711.dirty){
_715.style.display="inline";
}else{
_715.style.display="none";
}
};
maxwell.PipesEditorTabs.prototype.addEditor=function(_717){
...
YAHOO.util.Dom.removeClass(this.tabs.childNodes[this.tabs.childNodes.length-1],"last");
_719+=" last";
}
var node=cn("li",{className:_719,editorid:$id(_717.node)},null,txt);
this.tabs.appendChild(node);
_717.onload.subscribe(this.oneditorloadsave,this,true);
_717.onsave.subscribe(this.oneditorloadsave,this,true);
_717.onchange.subscribe(this.oneditorchange,this,true);
_717.onremove.subscribe(this.oneditorremove,this,true);
this.updateTabText(_717,node);
YAHOO.util.Event.addListener($id(node.getElementsByTagName("span")[0]),"click",function(e){
this.openEditor(_717);
YAHOO.util.Event.stopEvent(e);
},this,true);
return node;
};
...
var _729=this._editorAtIndex(this.shownTab);
this.inline.remove();
this.oncloseeditor.fire(_729,tab);
this.shownTab=-1;
};
maxwell.PipesEditorTabs.prototype.removeEditor=function(_72a){
_72a.onload.unsubscribe(this.oneditorloadsave,this,true);
_72a.onsave.unsubscribe(this.oneditorloadsave,this,true);
_72a.onchange.unsubscribe(this.oneditorchange,this,true);
_72a.onremove.unsubscribe(this.oneditorremove,this,true);
var _72b=this._indexOfEditor(_72a);
var tab=this.tabs.childNodes[_72b];
this.tabs.removeChild(tab);
if(this.tabs.childNodes.length==1){
YAHOO.util.Dom.addClass(this.tabs.childNodes[0],"only");
}else{
YAHOO.util.Dom.addClass(this.tabs.childNodes[this.tabs.childNodes.length-1],"last");
}
};
maxwell.PipesEditorTabs.prototype._indexOfEditor=function(_72d){
var id=$id(_72d.node);
...
maxwell.PipesEditorTabs.prototype._editorAtIndex=function(_730){
var id=this.tabs.childNodes[_730].getAttribute("editorid");
var _732=maxwell.PipesEditor.GetEditors();
for(var i=0;i<_732.length;i++){
if($id(_732[i].node)==id){
return _732[i];
}
}
return null;
};
maxwell.PipesEditorTabs.prototype.openEditor=function(_734){
var _735=this._indexOfEditor(_734);
if(this.shownTab==_735){
return;
}
this.closeEditor();
this.shownTab=_735;
var tab=this.tabs.childNodes[this.shownTab];
this.inline=new maxwell.InlineTextEdit(tab.getElementsByTagName("span")[0],"untitled");
this.inline.onchange.subscribe(function(type,args,self){
this.onchangetitle.fire(_734,args[0]);
},this,true);
this.onopeneditor.fire(_734,tab);
};
