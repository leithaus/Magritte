...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri May 30 01:42:31 PDT 2008
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  public json.Absyn.JSONObject pJSONObject() throws Exception
  {
	java_cup.runtime.Symbol res = parse();
	return (json.Absyn.JSONObject) res.value;
  }
      ...
      switch (CUP$parser$act_num)
        {
          ...
          case 16: // ListJSONValue ::= JSONValue _SYMB_5 ListJSONValue 
            {
              json.Absyn.ListJSONValue RESULT =null;
		json.Absyn.JSONValue p_1 = (json.Absyn.JSONValue)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		json.Absyn.ListJSONValue p_3 = (json.Absyn.ListJSONValue)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = p_3; p_3.addFirst(p_1); 
          ...
          case 15: // ListJSONValue ::= JSONValue 
            {
              json.Absyn.ListJSONValue RESULT =null;
		json.Absyn.JSONValue p_1 = (json.Absyn.JSONValue)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new json.Absyn.ListJSONValue(); RESULT.addLast(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("ListJSONValue",5, RESULT);
            }
          return CUP$parser$result;
          ...
          case 14: // ListJSONValue ::= 
            {
              json.Absyn.ListJSONValue RESULT =null;
		 RESULT = new json.Absyn.ListJSONValue(); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("ListJSONValue",5, RESULT);
            }
          return CUP$parser$result;
          ...
          case 13: // ListJSONPair ::= JSONPair _SYMB_5 ListJSONPair 
            {
              json.Absyn.ListJSONPair RESULT =null;
		json.Absyn.JSONPair p_1 = (json.Absyn.JSONPair)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		json.Absyn.ListJSONPair p_3 = (json.Absyn.ListJSONPair)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = p_3; p_3.addFirst(p_1); 
          ...
          case 12: // ListJSONPair ::= JSONPair 
            {
              json.Absyn.ListJSONPair RESULT =null;
		json.Absyn.JSONPair p_1 = (json.Absyn.JSONPair)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new json.Absyn.ListJSONPair(); RESULT.addLast(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("ListJSONPair",4, RESULT);
            }
          return CUP$parser$result;
          ...
          case 11: // ListJSONPair ::= 
            {
              json.Absyn.ListJSONPair RESULT =null;
		 RESULT = new json.Absyn.ListJSONPair(); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("ListJSONPair",4, RESULT);
            }
          return CUP$parser$result;
          ...
          case 10: // JSONValue ::= _SYMB_7 
            {
              json.Absyn.JSONValue RESULT =null;
		 RESULT = new json.Absyn.JNul(); 
		 ...
		 RESULT = new json.Absyn.JTru(); 
          ...
          case 7: // JSONValue ::= JSONArray 
            {
              json.Absyn.JSONValue RESULT =null;
		json.Absyn.JSONArray p_1 = (json.Absyn.JSONArray)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new json.Absyn.JArr(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("JSONValue",3, RESULT);
            }
          return CUP$parser$result;
          ...
          case 6: // JSONValue ::= JSONObject 
            {
              json.Absyn.JSONValue RESULT =null;
		json.Absyn.JSONObject p_1 = (json.Absyn.JSONObject)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new json.Absyn.JObj(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("JSONValue",3, RESULT);
            }
          return CUP$parser$result;
		...
		Double p_1 = (Double)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new json.Absyn.JNum(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("JSONValue",3, RESULT);
            }
          return CUP$parser$result;
		...
		String p_1 = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new json.Absyn.JStr(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("JSONValue",3, RESULT);
            }
          return CUP$parser$result;
          ...
          case 3: // JSONArray ::= _SYMB_3 ListJSONValue _SYMB_4 
            {
              json.Absyn.JSONArray RESULT =null;
		json.Absyn.ListJSONValue p_2 = (json.Absyn.ListJSONValue)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new json.Absyn.JArray(p_2); 
          ...
          case 2: // JSONPair ::= _STRING_ _SYMB_2 JSONValue 
            {
              json.Absyn.JSONPair RESULT =null;
		String p_1 = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		json.Absyn.JSONValue p_3 = (json.Absyn.JSONValue)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new json.Absyn.JPair(p_1,p_3); 
          ...
          case 1: // JSONObject ::= _SYMB_0 ListJSONPair _SYMB_1 
            {
              json.Absyn.JSONObject RESULT =null;
		json.Absyn.ListJSONPair p_2 = (json.Absyn.ListJSONPair)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new json.Absyn.JObject(p_2); 
          ...
          case 0: // $START ::= JSONObject EOF 
            {
              Object RESULT =null;
		json.Absyn.JSONObject start_val = (json.Absyn.JSONObject)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = start_val;
