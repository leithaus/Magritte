...
public class JArray extends JSONArray {
  ...
  public <R,A> R accept(json.Absyn.JSONArray.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof json.Absyn.JArray) {
      json.Absyn.JArray x = (json.Absyn.JArray)o;
