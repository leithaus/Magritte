    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.me.calculator.client.CalculatorWSService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.me.calculator.client.CalculatorWSService.class.getResource(".");
    ...
    public CalculatorWSService() {
        super(CALCULATORWSSERVICE_WSDL_LOCATION, new QName("http://calculator.me.org/", "CalculatorWSService"));
    }
