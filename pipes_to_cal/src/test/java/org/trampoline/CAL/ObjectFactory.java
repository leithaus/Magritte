...
public class ObjectFactory {
    ...
    private final static QName _AddResponse_QNAME = new QName("http://CAL.trampoline.org/", "addResponse");
    private final static QName _Add_QNAME = new QName("http://CAL.trampoline.org/", "add");
    private final static QName _ArithmeticException_QNAME = new QName("http://CAL.trampoline.org/", "ArithmeticException");
    private final static QName _Mult_QNAME = new QName("http://CAL.trampoline.org/", "mult");
    private final static QName _MultResponse_QNAME = new QName("http://CAL.trampoline.org/", "multResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://CAL.trampoline.org/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://CAL.trampoline.org/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://CAL.trampoline.org/", name = "ArithmeticException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://CAL.trampoline.org/", name = "mult")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://CAL.trampoline.org/", name = "multResponse")
